(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function e(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(r){if(r.ep)return;r.ep=!0;const o=e(r);fetch(r.href,o)}})();var Ye;class $t extends Error{}$t.prototype.name="InvalidTokenError";function gs(i){return decodeURIComponent(atob(i).replace(/(.)/g,(t,e)=>{let s=e.charCodeAt(0).toString(16).toUpperCase();return s.length<2&&(s="0"+s),"%"+s}))}function ms(i){let t=i.replace(/-/g,"+").replace(/_/g,"/");switch(t.length%4){case 0:break;case 2:t+="==";break;case 3:t+="=";break;default:throw new Error("base64 string is not of the correct length")}try{return gs(t)}catch{return atob(t)}}function xr(i,t){if(typeof i!="string")throw new $t("Invalid token specified: must be a string");t||(t={});const e=t.header===!0?0:1,s=i.split(".")[e];if(typeof s!="string")throw new $t(`Invalid token specified: missing part #${e+1}`);let r;try{r=ms(s)}catch(o){throw new $t(`Invalid token specified: invalid base64 for part #${e+1} (${o.message})`)}try{return JSON.parse(r)}catch(o){throw new $t(`Invalid token specified: invalid json for part #${e+1} (${o.message})`)}}const vs="mu:context",ye=`${vs}:change`;class ys{constructor(t,e){this._proxy=bs(t,e)}get value(){return this._proxy}set value(t){Object.assign(this._proxy,t)}apply(t){this.value=t(this.value)}}class Ae extends HTMLElement{constructor(t){super(),console.log("Constructing context provider",this),this.context=new ys(t,this),this.style.display="contents"}attach(t){return this.addEventListener(ye,t),t}detach(t){this.removeEventListener(ye,t)}}function bs(i,t){return new Proxy(i,{get:(s,r,o)=>{if(r==="then")return;const n=Reflect.get(s,r,o);return console.log(`Context['${r}'] => `,n),n},set:(s,r,o,n)=>{const l=i[r];console.log(`Context['${r.toString()}'] <= `,o);const a=Reflect.set(s,r,o,n);if(a){let f=new CustomEvent(ye,{bubbles:!0,cancelable:!0,composed:!0});Object.assign(f,{property:r,oldValue:l,value:o}),t.dispatchEvent(f)}else console.log(`Context['${r}] was not set to ${o}`);return a}})}function $s(i,t){const e=Sr(t,i);return new Promise((s,r)=>{if(e){const o=e.localName;customElements.whenDefined(o).then(()=>s(e))}else r({context:t,reason:`No provider for this context "${t}:`})})}function Sr(i,t){const e=`[provides="${i}"]`;if(!t||t===document.getRootNode())return;const s=t.closest(e);if(s)return s;const r=t.getRootNode();if(r instanceof ShadowRoot)return Sr(i,r.host)}class _s extends CustomEvent{constructor(t,e="mu:message"){super(e,{bubbles:!0,composed:!0,detail:t})}}function Ar(i="mu:message"){return(t,...e)=>t.dispatchEvent(new _s(e,i))}class ke{constructor(t,e,s="service:message",r=!0){this._pending=[],this._context=e,this._update=t,this._eventType=s,this._running=r}attach(t){t.addEventListener(this._eventType,e=>{e.stopPropagation();const s=e.detail;this.consume(s)})}start(){this._running||(console.log(`Starting ${this._eventType} service`),this._running=!0,this._pending.forEach(t=>this.process(t)))}apply(t){this._context.apply(t)}consume(t){this._running?this.process(t):(console.log(`Queueing ${this._eventType} message`,t),this._pending.push(t))}process(t){console.log(`Processing ${this._eventType} message`,t);const e=this._update(t,this.apply.bind(this));e&&e(this._context.value)}}function ws(i){return t=>({...t,...i})}const be="mu:auth:jwt",kr=class Er extends ke{constructor(t,e){super((s,r)=>this.update(s,r),t,Er.EVENT_TYPE),this._redirectForLogin=e}update(t,e){switch(t[0]){case"auth/signin":const{token:s,redirect:r}=t[1];return e(Ss(s)),pe(r);case"auth/signout":return e(As()),pe(this._redirectForLogin);case"auth/redirect":return pe(this._redirectForLogin,{next:window.location.href});default:const o=t[0];throw new Error(`Unhandled Auth message "${o}"`)}}};kr.EVENT_TYPE="auth:message";let Pr=kr;const Cr=Ar(Pr.EVENT_TYPE);function pe(i,t={}){if(!i)return;const e=window.location.href,s=new URL(i,e);return Object.entries(t).forEach(([r,o])=>s.searchParams.set(r,o)),()=>{console.log("Redirecting to ",i),window.location.assign(s)}}class xs extends Ae{get redirect(){return this.getAttribute("redirect")||void 0}constructor(){super({user:ct.authenticateFromLocalStorage()})}connectedCallback(){new Pr(this.context,this.redirect).attach(this)}}class lt{constructor(){this.authenticated=!1,this.username="anonymous"}static deauthenticate(t){return t.authenticated=!1,t.username="anonymous",localStorage.removeItem(be),t}}class ct extends lt{constructor(t){super();const e=xr(t);console.log("Token payload",e),this.token=t,this.authenticated=!0,this.username=e.username}static authenticate(t){const e=new ct(t);return localStorage.setItem(be,t),e}static authenticateFromLocalStorage(){const t=localStorage.getItem(be);return t?ct.authenticate(t):new lt}}function Ss(i){return ws({user:ct.authenticate(i),token:i})}function As(){return i=>{const t=i.user;return{user:t&&t.authenticated?lt.deauthenticate(t):t,token:""}}}function ks(i){return i.authenticated?{Authorization:`Bearer ${i.token||"NO_TOKEN"}`}:{}}function Es(i){return i.authenticated?xr(i.token||""):{}}const D=Object.freeze(Object.defineProperty({__proto__:null,AuthenticatedUser:ct,Provider:xs,User:lt,dispatch:Cr,headers:ks,payload:Es},Symbol.toStringTag,{value:"Module"}));function Ht(i,t,e){const s=i.target,r=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});console.log(`Relaying event from ${i.type}:`,r),s.dispatchEvent(r),i.stopPropagation()}function $e(i,t="*"){return i.composedPath().find(s=>{const r=s;return r.tagName&&r.matches(t)})}const re=Object.freeze(Object.defineProperty({__proto__:null,originalTarget:$e,relay:Ht},Symbol.toStringTag,{value:"Module"})),Ps=new DOMParser;function Tt(i,...t){const e=i.map((n,l)=>l?[t[l-1],n]:[n]).flat().join(""),s=Ps.parseFromString(e,"text/html"),r=s.head.childElementCount?s.head.children:s.body.children,o=new DocumentFragment;return o.replaceChildren(...r),o}function se(i){const t=i.firstElementChild,e=t&&t.tagName==="TEMPLATE"?t:void 0;return{attach:s};function s(r,o={mode:"open"}){const n=r.attachShadow(o);return e&&n.appendChild(e.content.cloneNode(!0)),n}}const Or=class Rr extends HTMLElement{constructor(){super(),this._state={},se(Rr.template).attach(this),this.addEventListener("change",t=>{const e=t.target;if(e){const s=e.name,r=e.value;s&&(this._state[s]=r)}}),this.form&&this.form.addEventListener("submit",t=>{t.preventDefault(),Ht(t,"mu-form:submit",this._state)})}set init(t){this._state=t||{},Os(this._state,this)}get form(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("form")}};Or.template=Tt`
    <template>
  ...
  `;let Cs=Or;function Os(i,t){const e=Object.entries(i);for(const[s,r]of e){const o=t.querySelector(`[name="${s}"]`);if(o){const n=o;switch(n.type){case"checkbox":const l=n;l.checked=!!r;break;case"date":n.value=r.toISOString().substr(0,10);break;default:n.value=r;break}}}return i}const Rs=Object.freeze(Object.defineProperty({__proto__:null,Element:Cs},Symbol.toStringTag,{value:"Module"})),Tr=class Ur extends ke{constructor(t){super((e,s)=>this.update(e,s),t,Ur.EVENT_TYPE)}update(t,e){switch(t[0]){case"history/navigate":{const{href:s,state:r}=t[1];e(Us(s,r));break}case"history/redirect":{const{href:s,state:r}=t[1];e(Ls(s,r));break}}}};Tr.EVENT_TYPE="history:message";let Ee=Tr;class Ve extends Ae{constructor(){super({location:document.location,state:{}}),this.addEventListener("click",t=>{const e=Ts(t);if(e){const s=new URL(e.href);s.origin===this.context.value.location.origin&&(console.log("Preventing Click Event on <A>",t),t.preventDefault(),Pe(e,"history/navigate",{href:s.pathname+s.search}))}}),window.addEventListener("popstate",t=>{console.log("Popstate",t.state),this.context.value={location:document.location,state:t.state}})}connectedCallback(){new Ee(this.context).attach(this)}}function Ts(i){const t=i.currentTarget,e=s=>s.tagName=="A"&&s.href;if(i.button===0)if(i.composed){const r=i.composedPath().find(e);return r||void 0}else{for(let s=i.target;s;s===t?null:s.parentElement)if(e(s))return s;return}}function Us(i,t={}){return history.pushState(t,"",i),()=>({location:document.location,state:history.state})}function Ls(i,t={}){return history.replaceState(t,"",i),()=>({location:document.location,state:history.state})}const Pe=Ar(Ee.EVENT_TYPE),Ut=Object.freeze(Object.defineProperty({__proto__:null,HistoryProvider:Ve,Provider:Ve,Service:Ee,dispatch:Pe},Symbol.toStringTag,{value:"Module"}));class I{constructor(t,e){this._effects=[],this._target=t,this._contextLabel=e}observe(t=void 0){return new Promise((e,s)=>{if(this._provider){const r=new Ke(this._provider,t);this._effects.push(r),e(r)}else $s(this._target,this._contextLabel).then(r=>{const o=new Ke(r,t);this._provider=r,this._effects.push(o),r.attach(n=>this._handleChange(n)),e(o)}).catch(r=>console.log(`Observer ${this._contextLabel} failed to locate a provider`,r))})}_handleChange(t){console.log("Received change event for observers",t,this._effects),this._effects.forEach(e=>e.runEffect())}}class Ke{constructor(t,e){this._provider=t,e&&this.setEffect(e)}get context(){return this._provider.context}get value(){return this.context.value}setEffect(t){this._effectFn=t,this.runEffect()}runEffect(){this._effectFn&&this._effectFn(this.context.value)}}const Ce=class Lr extends HTMLElement{constructor(){super(),this._state={},this._user=new lt,this._authObserver=new I(this,"blazing:auth"),se(Lr.template).attach(this),this.form&&this.form.addEventListener("submit",t=>{if(t.preventDefault(),this.src||this.action){if(console.log("Submitting form",this._state),this.action)this.action(this._state);else if(this.src){const e=this.isNew?"POST":"PUT",s=this.isNew?"created":"updated",r=this.isNew?this.src.replace(/[/][$]new$/,""):this.src;js(r,this._state,e,this.authorization).then(o=>mt(o,this)).then(o=>{const n=`mu-rest-form:${s}`,l=new CustomEvent(n,{bubbles:!0,composed:!0,detail:{method:e,[s]:o,url:r}});this.dispatchEvent(l)}).catch(o=>{const n="mu-rest-form:error",l=new CustomEvent(n,{bubbles:!0,composed:!0,detail:{method:e,error:o,url:r,request:this._state}});this.dispatchEvent(l)})}}}),this.addEventListener("change",t=>{const e=t.target;if(e){const s=e.name,r=e.value;s&&(this._state[s]=r)}})}get src(){return this.getAttribute("src")}get isNew(){return this.hasAttribute("new")}set init(t){this._state=t||{},mt(this._state,this)}get form(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("form")}get authorization(){var t;return(t=this._user)!=null&&t.authenticated?{Authorization:`Bearer ${this._user.token}`}:{}}connectedCallback(){this._authObserver.observe(({user:t})=>{t&&(this._user=t,this.src&&!this.isNew&&_e(this.src,this.authorization).then(e=>{this._state=e,mt(e,this)}))})}attributeChangedCallback(t,e,s){switch(t){case"src":this.src&&s&&s!==e&&!this.isNew&&_e(this.src,this.authorization).then(r=>{this._state=r,mt(r,this)});break;case"new":s&&(this._state={},mt({},this));break}}};Ce.observedAttributes=["src","new","action"];Ce.template=Tt`
    <template>
      <form autocomplete="off">
        <slot></slot>
        <slot name="submit">
...
`+this.showPosition(),{text:"",token:null,line:this.yylineno})},lex:function(){var d=this.next();return d||this.lex()},begin:function(d){this.conditionStack.push(d)},popState:function(){var d=this.conditionStack.length-1;return d>0?this.conditionStack.pop():this.conditionStack[0]},_currentRules:function(){return this.conditionStack.length&&this.conditionStack[this.conditionStack.length-1]?this.conditions[this.conditionStack[this.conditionStack.length-1]].rules:this.conditions.INITIAL.rules},topState:function(d){return d=this.conditionStack.length-1-Math.abs(d||0),d>=0?this.conditionStack[d]:"INITIAL"},pushState:function(d){this.begin(d)},stateStackSize:function(){return this.conditionStack.length},options:{},performAction:function(d,u,v,m){switch(v){case 0:return"(";case 1:return")";case 2:return"SPLAT";case 3:return"PARAM";case 4:return"LITERAL";case 5:return"LITERAL";case 6:return"EOF"}},rules:[/^(?:\()/,/^(?:\))/,/^(?:\*+\w+)/,/^(?::+\w+)/,/^(?:[\w%\-~\n]+)/,/^(?:.)/,/^(?:$)/],conditions:{INITIAL:{rules:[0,1,2,3,4,5,6],inclusive:!0}}};return h}();a.lexer=f;function g(){this.yy={}}return g.prototype=a,a.Parser=g,new g}();typeof li<"u"&&(i.parser=t,i.Parser=t.Parser,i.parse=function(){return t.parse.apply(t,arguments)})})(Yr);function it(i){return function(t,e){return{displayName:i,props:t,children:e||[]}}}var Vr={Root:it("Root"),Concat:it("Concat"),Literal:it("Literal"),Splat:it("Splat"),Param:it("Param"),Optional:it("Optional")},Kr=Yr.parser;Kr.yy=Vr;var ci=Kr,di=Object.keys(Vr);function hi(i){return di.forEach(function(t){if(typeof i[t]>"u")throw new Error("No handler defined for "+t.displayName)}),{visit:function(t,e){return this.handlers[t.displayName].call(this,t,e)},handlers:i}}var Zr=hi,pi=Zr,ui=/[\-{}\[\]+?.,\\\^$|#\s]/g;function Xr(i){this.captures=i.captures,this.re=i.re}Xr.prototype.match=function(i){var t=this.re.exec(i),e={};if(t)return this.captures.forEach(function(s,r){typeof t[r+1]>"u"?e[s]=void 0:e[s]=decodeURIComponent(t[r+1])}),e};var fi=pi({Concat:function(i){return i.children.reduce((function(t,e){var s=this.visit(e);return{re:t.re+s.re,captures:t.captures.concat(s.captures)}}).bind(this),{re:"",captures:[]})},Literal:function(i){return{re:i.props.value.replace(ui,"\\$&"),captures:[]}},Splat:function(i){return{re:"([^?]*?)",captures:[i.props.name]}},Param:function(i){return{re:"([^\\/\\?]+)",captures:[i.props.name]}},Optional:function(i){var t=this.visit(i.children[0]);return{re:"(?:"+t.re+")?",captures:t.captures}},Root:function(i){var t=this.visit(i.children[0]);return new Xr({re:new RegExp("^"+t.re+"(?=\\?|$)"),captures:t.captures})}}),gi=fi,mi=Zr,vi=mi({Concat:function(i,t){var e=i.children.map((function(s){return this.visit(s,t)}).bind(this));return e.some(function(s){return s===!1})?!1:e.join("")},Literal:function(i){return decodeURI(i.props.value)},Splat:function(i,t){return t[i.props.name]?t[i.props.name]:!1},Param:function(i,t){return t[i.props.name]?t[i.props.name]:!1},Optional:function(i,t){var e=this.visit(i.children[0],t);return e||""},Root:function(i,t){t=t||{};var e=this.visit(i.children[0],t);return e?encodeURI(e):!1}}),yi=vi,bi=ci,$i=gi,_i=yi;Lt.prototype=Object.create(null);Lt.prototype.match=function(i){var t=$i.visit(this.ast),e=t.match(i);return e||!1};Lt.prototype.reverse=function(i){return _i.visit(this.ast,i)};function Lt(i){var t;if(this?t=this:t=Object.create(Lt.prototype),typeof i>"u")throw new Error("A route spec is required");return t.spec=i,t.ast=bi.parse(i),t}var wi=Lt,xi=wi,Si=xi;const Ai=ai(Si);var ki=Object.defineProperty,Ei=Object.getOwnPropertyDescriptor,ts=(i,t,e,s)=>{for(var r=s>1?void 0:s?Ei(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=(s?n(t,e,r):n(r))||r);return s&&r&&ki(t,e,r),r};class kt extends at{constructor(t,e,s=""){super(),this._cases=[],this._fallback=()=>yt`
    ...
    `,this._cases=t.map(r=>({...r,route:new Ai(r.path)})),this._historyObserver=new I(this,e),this._authObserver=new I(this,s)}connectedCallback(){this._historyObserver.observe(({location:t})=>{console.log("New location",t),t&&(this._match=this.matchRoute(t))}),this._authObserver.observe(({user:t})=>{this._user=t}),super.connectedCallback()}render(){return console.log("Rendering for match",this._match,this._user),yt`
      <main>${(()=>{const e=this._match;if(e){if("view"in e)return this._user?e.auth&&e.auth!=="public"&&this._user&&!this._user.authenticated?(Cr(this,"auth/redirect"),yt`
    ...
    `}updated(t){t.has("_match")&&this.requestUpdate()}matchRoute(t){const{search:e,pathname:s}=t,r=new URLSearchParams(e),o=s+e;for(const n of this._cases){const l=n.route.match(o);if(l)return{...n,path:s,params:l,query:r}}}redirect(t){Pe(this,"history/redirect",{href:t})}}kt.styles=Ds`
    :host,
    main {
      display: contents;
    }
  `;ts([Jr()],kt.prototype,"_user",2);ts([Jr()],kt.prototype,"_match",2);const Pi=Object.freeze(Object.defineProperty({__proto__:null,Element:kt,Switch:kt},Symbol.toStringTag,{value:"Module"})),Ci=class es extends HTMLElement{constructor(){if(super(),se(es.template).attach(this),this.shadowRoot){const t=this.shadowRoot.querySelector("slot[name='actuator']");t&&t.addEventListener("click",()=>this.toggle())}}toggle(){this.hasAttribute("open")?this.removeAttribute("open"):this.setAttribute("open","open")}};Ci.template=Tt`
    <template>
  ...
  `;const Oi=class rs extends HTMLElement{constructor(){super(),this._array=[],se(rs.template).attach(this),this.addEventListener("input-array:add",t=>{t.stopPropagation(),this.append(ss("",this._array.length))}),this.addEventListener("input-array:remove",t=>{t.stopPropagation(),this.removeClosestItem(t.target)}),this.addEventListener("change",t=>{t.stopPropagation();const e=t.target;if(e&&e!==this){const s=new Event("change",{bubbles:!0}),r=e.value,o=e.closest("label");if(o){const n=Array.from(this.children).indexOf(o);this._array[n]=r,this.dispatchEvent(s)}}}),this.addEventListener("click",t=>{$e(t,"button.add")?Ht(t,"input-array:add"):$e(t,"button.remove")&&Ht(t,"input-array:remove")})}get name(){return this.getAttribute("name")}get value(){return this._array}set value(t){this._array=Array.isArray(t)?t:[t],Ri(this._array,this)}removeClosestItem(t){const e=t.closest("label");if(console.log("Removing closest item:",e,t),e){const s=Array.from(this.children).indexOf(e);this._array.splice(s,1),e.remove()}}};Oi.template=Tt`
    <template>
      <ul>
        <slot></slot>
      </ul>
 ...
 */class E extends nt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Xi(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return ut}}var wr;E._$litElement$=!0,E.finalized=!0,(wr=globalThis.litElementHydrateSupport)==null||wr.call(globalThis,{LitElement:E});const ve=globalThis.litElementPolyfillSupport;ve==null||ve({LitElement:E});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.0.5");const to={};function eo(i,t,e){switch(i[0]){case"profile/save":ro(i[1],e).then(r=>t(o=>({...o,profile:r}))).then(()=>{const{onSuccess:r}=i[1];r&&r()}).catch(r=>{const{onFailure:o}=i[1];o&&o(r)});break;case"profile/select":so(i[1],e).then(r=>t(o=>({...o,profile:r})));break;case"study-spot/index":io().then(r=>t(o=>({...o,studySpotIndex:r}))).catch(r=>{console.error("Failed to fetch study spots",r)});break;case"study-spot/select":oo(i[1]).then(r=>t(o=>({...o,studySpot:r})));break;case"study-spot/add":no(i[1],e).then(r=>t(o=>({...o,studySpot:r}))).then(()=>{const{onSuccess:r}=i[1];r&&r()}).catch(r=>{const{onFailure:o}=i[1];o&&o(r)});break;case"study-spot/update":ao({spotid:i[1].spotid,ratings:i[1].rating,reviewsCount:i[1].reviewsCount},e).then(r=>t(o=>({...o,studySpot:r}))).then(()=>{const{onSuccess:r}=i[1];r&&r()}).catch(r=>{const{onFailure:o}=i[1];o&&o(r)});break;case"review/list-by-spot":lo(i[1].spotId).then(r=>t(o=>({...o,reviews:r})));break;case"review/list-by-user":ho(i[1].userId).then(r=>t(o=>({...o,reviews:r})));break;case"review/add":co(i[1],e).then(r=>{r&&t(o=>({...o,reviews:[...o.reviews??[],r]}))}).then(()=>{const{onSuccess:r}=i[1];r&&r()}).catch(r=>{const{onFailure:o}=i[1];o&&o(r)});break;case"review/clear":t(r=>({...r,reviews:[]}));break;default:const s=i[0];throw new Error(`Unhandled message "${s}"`)}}function ro(i,t){return fetch(`/api/profiles/${i.userid}`,{method:"PUT",headers:{"Content-Type":"application/json",...D.headers(t)},body:JSON.stringify(i.profile)}).then(e=>{if(e.status===200)return e.json();throw new Error(`Failed to save profile for ${i.userid}`)}).then(e=>{if(e)return e})}function so(i,t){return fetch(`/api/profiles/${i.userid}`,{headers:D.headers(t)}).then(e=>{if(e.status===200)return e.json()}).then(e=>{if(e)return console.log("Profile:",e),e})}function io(){return fetch("/study-spots",{method:"GET",headers:{"Content-Type":"application/json"}}).then(i=>{if(i.status===200)return i.json();throw void 0}).then(i=>{if(i){const{data:t}=i;return t}})}function oo(i){return fetch(`/study-spots/${i.spotid}`,{method:"GET"}).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("Study Spot:",t),t})}function no(i,t){return fetch("/study-spots",{method:"POST",headers:{"Content-Type":"application/json",...D.headers(t)},body:JSON.stringify(i.spot)}).then(e=>{if(e.status===201)return e.json();throw new Error("Failed to add study spot")}).then(e=>{if(e)return e})}function ao(i,t){return fetch(`/study-spots/${i.spotid}`,{method:"PUT",headers:{"Content-Type":"application/json",...D.headers(t)},body:JSON.stringify({ratings:i.ratings,reviewsCount:i.reviewsCount})}).then(e=>{if(e.status===200)return e.json();throw new Error(`Failed to update study spot ${i.spotid}`)}).then(e=>{if(e)return e})}function lo(i){return fetch(`/reviews/spot/${i}`,{method:"GET",headers:{"Content-Type":"application/json"}}).then(t=>{if(t.status===200)return t.json();if(t.status===404)return console.log(`No reviews found for study spot ${i}`),[];throw new Error(`Failed to fetch reviews for study spot ${i}. Status: ${t.status}`)}).then(t=>t||[]).catch(t=>{throw console.error(t.message),t})}function co(i,t){return fetch("/reviews",{method:"POST",headers:{"Content-Type":"application/json",...D.headers(t)},body:JSON.stringify(i.review)}).then(e=>{if(e.status===201)return e.json();throw new Error("Failed to add review")}).then(e=>{if(e)return e})}function ho(i){return fetch(`/reviews/user/${i}`,{method:"GET",headers:{"Content-Type":"application/json"}}).then(t=>{if(t.status===200)return t.json();throw new Error(`Failed to fetch reviews for user ${i}`)}).then(t=>t||[])}const ze=class ze extends E{constructor(){super(...arguments),this._onClickAway=t=>{this.contains(t.target)||(this.removeAttribute("open"),window.removeEventListener("click",this._onClickAway))}}render(){return p`
    ...
    `}toggle(){this.hasAttribute("open")?(this.removeAttribute("open"),window.removeEventListener("click",this._onClickAway)):(this.setAttribute("open",""),setTimeout(()=>{window.addEventListener("click",this._onClickAway)},0))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("click",this._onClickAway)}};ze.styles=S`
    :host {
      position: relative;
...
`,fo=localStorage.getItem("dark-mode")==="true";function go(){document.body.classList.add("dark-mode"),localStorage.setItem("dark-mode","true")}function mo(){document.body.classList.remove("dark-mode"),localStorage.setItem("dark-mode","false")}function ds(i){i?go():mo()}ds(fo);document.body.addEventListener("dark-mode",()=>{const i=localStorage.getItem("dark-mode")==="true";ds(!i)});var vo=Object.defineProperty,yo=Object.getOwnPropertyDescriptor,bo=(i,t,e,s)=>{for(var r=s>1?void 0:s?yo(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=(s?n(t,e,r):n(r))||r);return s&&r&&vo(t,e,r),r};const Zt=class Zt extends E{constructor(){super(...arguments),this.username="anonymous",this._authObserver=new I(this,"slostudyspots:auth")}connectedCallback(){super.connectedCallback(),this._authObserver.observe(({user:t})=>{t?this.username=t.username:this.username="anonymous"})}render(){return p`
            ...
            ${this.username==="anonymous"?p`
                ...
                <drop-down>
                  <ul>
                    ...
                    <!-- <li>
                      <label class="light-dark-switch" @change=${_r}>
    ...
    `}};Zt.uses=L({"drop-down":Gt}),Zt.styles=[O,S`
    header.navbar {
      display: flex;
  ...
  `];let Jt=Zt;bo([P()],Jt.prototype,"username",2);function _r(i){re.relay(i,"dark-mode",{checked:void 0})}function $o(i){re.relay(i,"auth:message",["auth/signout"])}var _o=Object.defineProperty,wo=Object.getOwnPropertyDescriptor,X=(i,t,e,s)=>{for(var r=s>1?void 0:s?wo(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=(s?n(t,e,r):n(r))||r);return s&&r&&_o(t,e,r),r};const hs=S`
  slot[name="avatar"] {
    display: block;
    grid-row: 1 / span 2;
    width: 120px;
...
`,Ie=class Ie extends E{render(){return p`
    <main>
  ...
  `}};Ie.styles=[O,hs,S`
    ...
    `];let Yt=Ie;X([$()],Yt.prototype,"username",2);const Xt=class Xt extends E{constructor(){super(),this._handleAvatarSelected=this._handleAvatarSelected.bind(this)}render(){return p`
      <main>
    ...
    `];let Ot=Xt;X([$()],Ot.prototype,"username",2);X([$({attribute:!1})],Ot.prototype,"init",2);const te=class te extends Z{constructor(){super("slostudyspots:model"),this.edit=!1,this.userid="",this.addEventListener("profile:new-avatar",t=>{this.newAvatar=t.detail})}get profile(){return this.model.profile}attributeChangedCallback(t,e,s){super.attributeChangedCallback(t,e,s),t==="user-id"&&e!==s&&s&&(console.log("Profiler Page:",s),this.dispatchMessage(["profile/select",{userid:s}]))}render(){var g,h,c;const{avatar:t,name:e,userid:s,email:r,bio:o,reviewsCount:n}=this.profile||{},l=((h=(g=this.profile)==null?void 0:g.favSpots)==null?void 0:h.map(d=>p`<li>${d}</li>`))||p``,a=(c=this.profile)!=null&&c.dateJoined?new Date(this.profile.dateJoined).toLocaleDateString():"Date unavailable",f=this.newAvatar||t?p`<img src=${this.newAvatar||t} alt="Profile Avatar" slot="avatar">`:p`<img slot="avatar" src="/icons/default-profile.svg">`;return this.edit?p`
        <profile-editor
          username=${s}
          .init=${this.profile}
      ...
      `}_handleSubmit(t){console.log("Handling submit of mu-form");const e=this.newAvatar?{...t.detail,avatar:this.newAvatar}:t.detail;this.dispatchMessage(["profile/save",{userid:this.userid,profile:e,onSuccess:()=>Ut.dispatch(this,"history/navigate",{href:`/app/profile/${this.userid}`}),onFailure:s=>console.log("ERROR:",s)}])}};te.uses=L({"profile-viewer":Yt,"profile-editor":Ot}),te.styles=[O];let V=te;X([$({type:Boolean,reflect:!0})],V.prototype,"edit",2);X([$({attribute:"user-id",reflect:!0})],V.prototype,"userid",2);X([P()],V.prototype,"profile",1);X([P()],V.prototype,"newAvatar",2);var xo=Object.defineProperty,So=Object.getOwnPropertyDescriptor,Ao=(i,t,e,s)=>{for(var r=s>1?void 0:s?So(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=(s?n(t,e,r):n(r))||r);return s&&r&&xo(t,e,r),r};L({"restful-form":Nr.FormElement});const De=class De extends E{constructor(){super(...arguments),this.message=""}render(){return p`
      <restful-form
        new
    ...
    `}get next(){return new URLSearchParams(document.location.search).get("next")}_handleSuccess(t){const e=t.detail,{token:s}=e.created,r=this.next||"/";console.log("Login successful",e,r),re.relay(t,"auth:message",["auth/signin",{token:s,redirect:r}]),Ut.dispatch(this,"history/navigate",{href:"/app"})}_handleError(t){const{error:e}=t.detail;console.log("Login failed",t.detail),this.message=e.toString()}};De.styles=S`
    .error {
      color: firebrick;
    }
  `;let Vt=De;Ao([$()],Vt.prototype,"message",2);L({"mu-auth":D.Provider,"login-form":Vt});const He=class He extends E{render(){return p`
    ...
    `];let xe=He;L({"restful-form":Nr.FormElement});class ko extends E{render(){return p`
      <restful-form new src="/auth/register">
        <slot></slot>
      </restful-form>
    `}get next(){return new URLSearchParams(document.location.search).get("next")}constructor(){super(),this.addEventListener("mu-rest-form:created",t=>{const e=t.detail,{token:s}=e.created,r=this.next||"/";console.log("Signup successful",e,r),re.relay(t,"auth:message",["auth/signin",{token:s,redirect:r}])})}}L({"mu-auth":D.Provider,"register-form":ko});const Fe=class Fe extends E{render(){return p`
      <div class="login-register-container">
    ...
    `];let Se=Fe;var Eo=Object.defineProperty,Po=Object.getOwnPropertyDescriptor,ps=(i,t,e,s)=>{for(var r=s>1?void 0:s?Po(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=(s?n(t,e,r):n(r))||r);return s&&r&&Eo(t,e,r),r};const qe=class qe extends E{constructor(){super(...arguments),this.open=!1,this.sort=!1}openPopup(){this.open=!0}closePopup(t){t.target.classList.contains("popup-overlay")&&(this.open=!1)}triggerSort(t){this.dispatchEvent(new CustomEvent("sort-requested",{detail:{sortType:t}})),this.open=!1}render(){return p`
  ...
  `];let Rt=qe;ps([$({type:Boolean})],Rt.prototype,"open",2);ps([P()],Rt.prototype,"sort",2);var Co=Object.defineProperty,Oo=Object.getOwnPropertyDescriptor,ne=(i,t,e,s)=>{for(var r=s>1?void 0:s?Oo(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=(s?n(t,e,r):n(r))||r);return s&&r&&Co(t,e,r),r};const ee=class ee extends Z{constructor(){super("slostudyspots:model"),this.isPopupOpen=!1,this.filterTerm="",this.filteredStudySpots=[],this.updateFilteredStudySpots()}get studySpotIndex(){return this.model.studySpotIndex||[]}connectedCallback(){super.connectedCallback(),this.dispatchMessage(["study-spot/index"])}togglePopup(){this.isPopupOpen=!this.isPopupOpen}updateFilteredStudySpots(){this.filteredStudySpots=this.studySpotIndex.filter(t=>t.name.toLowerCase().includes(this.filterTerm.toLowerCase()))}handleSortRequested(t){t.detail.sortType==="alphabetically"&&(this.studySpotIndex.sort((s,r)=>s.name.localeCompare(r.name)),this.filteredStudySpots=this.studySpotIndex.filter(s=>s.name.toLowerCase().includes(this.filterTerm.toLowerCase()))),this.isPopupOpen=!1}updateFilterTerm(t){const e=t.target;this.filterTerm=e.value,this.updateFilteredStudySpots()}renderStars(t){const e=Math.floor(t),s=t%1>=.5?1:0,r=5-e-s,o=[];for(let n=0;n<e;n++)o.push(p`<span class="star full"></span>`);s&&o.push(p`<span class="star half"></span>`);for(let n=0;n<r;n++)o.push(p`<span class="star empty"></span>`);return p`${o}`}render(){const t=s=>{var g;const{name:r,ratings:o,reviewsCount:n}=s,{_id:l}=s,a=((g=s.photos)==null?void 0:g[0])||"/icons/default-spot.webp",f=o.overall.toFixed(1);return p`
    ...
    `}};ee.uses=L({"filter-popup":Rt}),ee.styles=[O,S`
      main {
        padding: var(--space-regular);
        flex-grow: 1;
      }
    ...
    `];let gt=Be;Me([$({attribute:"spot-id",reflect:!0})],gt.prototype,"spotid",2);Me([P()],gt.prototype,"studySpot",1);Me([P()],gt.prototype,"reviews",1);var Uo=Object.defineProperty,Lo=Object.getOwnPropertyDescriptor,tt=(i,t,e,s)=>{for(var r=s>1?void 0:s?Lo(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=(s?n(t,e,r):n(r))||r);return s&&r&&Uo(t,e,r),r};const We=class We extends Z{constructor(){super("slostudyspots:model"),this.name="",this.address="",this.locationType="",this.customLocationType="",this.tags="",this.link="",this.createdBy="",this._authObserver=new I(this,"slostudyspots:auth")}connectedCallback(){super.connectedCallback(),this._authObserver.observe(({user:t})=>{t&&(this.createdBy=t.username)})}render(){return p`
    <main>
    ...
    `];let T=We;tt([$({type:String})],T.prototype,"name",2);tt([$({type:String})],T.prototype,"address",2);tt([$({type:String})],T.prototype,"locationType",2);tt([$({type:String})],T.prototype,"customLocationType",2);tt([$({type:String})],T.prototype,"tags",2);tt([$({type:String})],T.prototype,"link",2);tt([$({type:String})],T.prototype,"createdBy",2);var No=Object.defineProperty,jo=Object.getOwnPropertyDescriptor,Mo=(i,t,e,s)=>{for(var r=s>1?void 0:s?jo(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=(s?n(t,e,r):n(r))||r);return s&&r&&No(t,e,r),r};const Qe=class Qe extends Z{get sortedStudySpots(){return[...this.model.studySpotIndex||[]].sort((t,e)=>{const s=e.ratings.overall-t.ratings.overall;return s!==0?s:e.reviewsCount-t.reviewsCount})}constructor(){super("slostudyspots:model")}connectedCallback(){super.connectedCallback(),this.dispatchMessage(["study-spot/index"])}renderStars(t){const e=Math.floor(t),s=t%1>=.5?1:0,r=5-e-s,o=[];for(let n=0;n<e;n++)o.push(p`<span class="star full"></span>`);s&&o.push(p`<span class="star half"></span>`);for(let n=0;n<r;n++)o.push(p`<span class="star empty"></span>`);return p`${o}`}render(){const t=e=>{const{name:s,ratings:r,reviewsCount:o}=e,{_id:n}=e;return p`
      <a href="study-spot/${n}">
        <li class="ranking">
          <div class="content">
            <h3>${s}</h3>
    ...
    `},{path:"/app/login",view:()=>p` <login-view></login-view> `},{path:"/app/register",view:()=>p` <register-view></register-view> `},{path:"/app",view:()=>p`
      <home-view></home-view>
    `},{path:"/",redirect:"/app"}];L({"mu-auth":D.Provider,"mu-history":Ut.Provider,"mu-store":class extends zs.Provider{constructor(){super(eo,to,"slostudyspots:auth")}},"mu-switch":class extends Pi.Element{constructor(){super(Do,"slostudyspots:history","slostudyspots:auth")}},"nav-header":Jt,"profile-view":V,"login-view":xe,"register-view":Se,"home-view":K,"study-spot-view":gt,"add-spot-view":T,"rankings-view":Kt,"add-review-view":k});
