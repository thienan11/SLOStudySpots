(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function e(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(r){if(r.ep)return;r.ep=!0;const o=e(r);fetch(r.href,o)}})();var pr;class kt extends Error{}kt.prototype.name="InvalidTokenError";function Ts(i){return decodeURIComponent(atob(i).replace(/(.)/g,(t,e)=>{let s=e.charCodeAt(0).toString(16).toUpperCase();return s.length<2&&(s="0"+s),"%"+s}))}function Us(i){let t=i.replace(/-/g,"+").replace(/_/g,"/");switch(t.length%4){case 0:break;case 2:t+="==";break;case 3:t+="=";break;default:throw new Error("base64 string is not of the correct length")}try{return Ts(t)}catch{return atob(t)}}function zr(i,t){if(typeof i!="string")throw new kt("Invalid token specified: must be a string");t||(t={});const e=t.header===!0?0:1,s=i.split(".")[e];if(typeof s!="string")throw new kt(`Invalid token specified: missing part #${e+1}`);let r;try{r=Us(s)}catch(o){throw new kt(`Invalid token specified: invalid base64 for part #${e+1} (${o.message})`)}try{return JSON.parse(r)}catch(o){throw new kt(`Invalid token specified: invalid json for part #${e+1} (${o.message})`)}}const Is="mu:context",Oe=`${Is}:change`;class Ls{constructor(t,e){this._proxy=js(t,e)}get value(){return this._proxy}set value(t){Object.assign(this._proxy,t)}apply(t){this.value=t(this.value)}}class ze extends HTMLElement{constructor(t){super(),console.log("Constructing context provider",this),this.context=new Ls(t,this),this.style.display="contents"}attach(t){return this.addEventListener(Oe,t),t}detach(t){this.removeEventListener(Oe,t)}}function js(i,t){return new Proxy(i,{get:(s,r,o)=>{if(r==="then")return;const a=Reflect.get(s,r,o);return console.log(`Context['${r}'] => `,a),a},set:(s,r,o,a)=>{const n=i[r];console.log(`Context['${r.toString()}'] <= `,o);const l=Reflect.set(s,r,o,a);if(l){let g=new CustomEvent(Oe,{bubbles:!0,cancelable:!0,composed:!0});Object.assign(g,{property:r,oldValue:n,value:o}),t.dispatchEvent(g)}else console.log(`Context['${r}] was not set to ${o}`);return l}})}function Ms(i,t){const e=Dr(t,i);return new Promise((s,r)=>{if(e){const o=e.localName;customElements.whenDefined(o).then(()=>s(e))}else r({context:t,reason:`No provider for this context "${t}:`})})}function Dr(i,t){const e=`[provides="${i}"]`;if(!t||t===document.getRootNode())return;const s=t.closest(e);if(s)return s;const r=t.getRootNode();if(r instanceof ShadowRoot)return Dr(i,r.host)}class zs extends CustomEvent{constructor(t,e="mu:message"){super(e,{bubbles:!0,composed:!0,detail:t})}}function Nr(i="mu:message"){return(t,...e)=>t.dispatchEvent(new zs(e,i))}class De{constructor(t,e,s="service:message",r=!0){this._pending=[],this._context=e,this._update=t,this._eventType=s,this._running=r}attach(t){t.addEventListener(this._eventType,e=>{e.stopPropagation();const s=e.detail;this.consume(s)})}start(){this._running||(console.log(`Starting ${this._eventType} service`),this._running=!0,this._pending.forEach(t=>this.process(t)))}apply(t){this._context.apply(t)}consume(t){this._running?this.process(t):(console.log(`Queueing ${this._eventType} message`,t),this._pending.push(t))}process(t){console.log(`Processing ${this._eventType} message`,t);const e=this._update(t,this.apply.bind(this));e&&e(this._context.value)}}function Ds(i){return t=>({...t,...i})}const Ce="mu:auth:jwt",Fr=class qr extends De{constructor(t,e){super((s,r)=>this.update(s,r),t,qr.EVENT_TYPE),this._redirectForLogin=e}update(t,e){switch(t[0]){case"auth/signin":const{token:s,redirect:r}=t[1];return e(Fs(s)),Se(r);case"auth/signout":return e(qs()),Se(this._redirectForLogin);case"auth/redirect":return Se(this._redirectForLogin,{next:window.location.href});default:const o=t[0];throw new Error(`Unhandled Auth message "${o}"`)}}};Fr.EVENT_TYPE="auth:message";let Hr=Fr;const Br=Nr(Hr.EVENT_TYPE);function Se(i,t={}){if(!i)return;const e=window.location.href,s=new URL(i,e);return Object.entries(t).forEach(([r,o])=>s.searchParams.set(r,o)),()=>{console.log("Redirecting to ",i),window.location.assign(s)}}class Ns extends ze{get redirect(){return this.getAttribute("redirect")||void 0}constructor(){super({user:ut.authenticateFromLocalStorage()})}connectedCallback(){new Hr(this.context,this.redirect).attach(this)}}class ht{constructor(){this.authenticated=!1,this.username="anonymous"}static deauthenticate(t){return t.authenticated=!1,t.username="anonymous",localStorage.removeItem(Ce),t}}class ut extends ht{constructor(t){super();const e=zr(t);console.log("Token payload",e),this.token=t,this.authenticated=!0,this.username=e.username}static authenticate(t){const e=new ut(t);return localStorage.setItem(Ce,t),e}static authenticateFromLocalStorage(){const t=localStorage.getItem(Ce);return t?ut.authenticate(t):new ht}}function Fs(i){return Ds({user:ut.authenticate(i),token:i})}function qs(){return i=>{const t=i.user;return{user:t&&t.authenticated?ht.deauthenticate(t):t,token:""}}}function Hs(i){return i.authenticated?{Authorization:`Bearer ${i.token||"NO_TOKEN"}`}:{}}function Bs(i){return i.authenticated?zr(i.token||""):{}}const z=Object.freeze(Object.defineProperty({__proto__:null,AuthenticatedUser:ut,Provider:Ns,User:ht,dispatch:Br,headers:Hs,payload:Bs},Symbol.toStringTag,{value:"Module"}));function Jt(i,t,e){const s=i.target,r=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});console.log(`Relaying event from ${i.type}:`,r),s.dispatchEvent(r),i.stopPropagation()}function Te(i,t="*"){return i.composedPath().find(s=>{const r=s;return r.tagName&&r.matches(t)})}const Ne=Object.freeze(Object.defineProperty({__proto__:null,originalTarget:Te,relay:Jt},Symbol.toStringTag,{value:"Module"})),Qs=new DOMParser;function zt(i,...t){const e=i.map((a,n)=>n?[t[n-1],a]:[a]).flat().join(""),s=Qs.parseFromString(e,"text/html"),r=s.head.childElementCount?s.head.children:s.body.children,o=new DocumentFragment;return o.replaceChildren(...r),o}function pe(i){const t=i.firstElementChild,e=t&&t.tagName==="TEMPLATE"?t:void 0;return{attach:s};function s(r,o={mode:"open"}){const a=r.attachShadow(o);return e&&a.appendChild(e.content.cloneNode(!0)),a}}const Qr=class Wr extends HTMLElement{constructor(){super(),this._state={},pe(Wr.template).attach(this),this.addEventListener("change",t=>{const e=t.target;if(e){const s=e.name,r=e.value;s&&(this._state[s]=r)}}),this.form&&this.form.addEventListener("submit",t=>{t.preventDefault(),Jt(t,"mu-form:submit",this._state)})}set init(t){this._state=t||{},Gs(this._state,this)}get form(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("form")}};Qr.template=zt`
    <template>
  ...
  `;let Ws=Qr;function Gs(i,t){const e=Object.entries(i);for(const[s,r]of e){const o=t.querySelector(`[name="${s}"]`);if(o){const a=o;switch(a.type){case"checkbox":const n=a;n.checked=!!r;break;case"date":a.value=r.toISOString().substr(0,10);break;default:a.value=r;break}}}return i}const Gr=Object.freeze(Object.defineProperty({__proto__:null,Element:Ws},Symbol.toStringTag,{value:"Module"})),Jr=class Yr extends De{constructor(t){super((e,s)=>this.update(e,s),t,Yr.EVENT_TYPE)}update(t,e){switch(t[0]){case"history/navigate":{const{href:s,state:r}=t[1];e(Ys(s,r));break}case"history/redirect":{const{href:s,state:r}=t[1];e(Ks(s,r));break}}}};Jr.EVENT_TYPE="history:message";let Fe=Jr;class hr extends ze{constructor(){super({location:document.location,state:{}}),this.addEventListener("click",t=>{const e=Js(t);if(e){const s=new URL(e.href);s.origin===this.context.value.location.origin&&(console.log("Preventing Click Event on <A>",t),t.preventDefault(),qe(e,"history/navigate",{href:s.pathname+s.search}))}}),window.addEventListener("popstate",t=>{console.log("Popstate",t.state),this.context.value={location:document.location,state:t.state}})}connectedCallback(){new Fe(this.context).attach(this)}}function Js(i){const t=i.currentTarget,e=s=>s.tagName=="A"&&s.href;if(i.button===0)if(i.composed){const r=i.composedPath().find(e);return r||void 0}else{for(let s=i.target;s;s===t?null:s.parentElement)if(e(s))return s;return}}function Ys(i,t={}){return history.pushState(t,"",i),()=>({location:document.location,state:history.state})}function Ks(i,t={}){return history.replaceState(t,"",i),()=>({location:document.location,state:history.state})}const qe=Nr(Fe.EVENT_TYPE),st=Object.freeze(Object.defineProperty({__proto__:null,HistoryProvider:hr,Provider:hr,Service:Fe,dispatch:qe},Symbol.toStringTag,{value:"Module"}));class T{constructor(t,e){this._effects=[],this._target=t,this._contextLabel=e}observe(t=void 0){return new Promise((e,s)=>{if(this._provider){const r=new ur(this._provider,t);this._effects.push(r),e(r)}else Ms(this._target,this._contextLabel).then(r=>{const o=new ur(r,t);this._provider=r,this._effects.push(o),r.attach(a=>this._handleChange(a)),e(o)}).catch(r=>console.log(`Observer ${this._contextLabel} failed to locate a provider`,r))})}_handleChange(t){console.log("Received change event for observers",t,this._effects),this._effects.forEach(e=>e.runEffect())}}class ur{constructor(t,e){this._provider=t,e&&this.setEffect(e)}get context(){return this._provider.context}get value(){return this.context.value}setEffect(t){this._effectFn=t,this.runEffect()}runEffect(){this._effectFn&&this._effectFn(this.context.value)}}const He=class Kr extends HTMLElement{constructor(){super(),this._state={},this._user=new ht,this._authObserver=new T(this,"blazing:auth"),pe(Kr.template).attach(this),this.form&&this.form.addEventListener("submit",t=>{if(t.preventDefault(),this.src||this.action){if(console.log("Submitting form",this._state),this.action)this.action(this._state);else if(this.src){const e=this.isNew?"POST":"PUT",s=this.isNew?"created":"updated",r=this.isNew?this.src.replace(/[/][$]new$/,""):this.src;Xs(r,this._state,e,this.authorization).then(o=>$t(o,this)).then(o=>{const a=`mu-rest-form:${s}`,n=new CustomEvent(a,{bubbles:!0,composed:!0,detail:{method:e,[s]:o,url:r}});this.dispatchEvent(n)}).catch(o=>{const a="mu-rest-form:error",n=new CustomEvent(a,{bubbles:!0,composed:!0,detail:{method:e,error:o,url:r,request:this._state}});this.dispatchEvent(n)})}}}),this.addEventListener("change",t=>{const e=t.target;if(e){const s=e.name,r=e.value;s&&(this._state[s]=r)}})}get src(){return this.getAttribute("src")}get isNew(){return this.hasAttribute("new")}set init(t){this._state=t||{},$t(this._state,this)}get form(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("form")}get authorization(){var t;return(t=this._user)!=null&&t.authenticated?{Authorization:`Bearer ${this._user.token}`}:{}}connectedCallback(){this._authObserver.observe(({user:t})=>{t&&(this._user=t,this.src&&!this.isNew&&Ue(this.src,this.authorization).then(e=>{this._state=e,$t(e,this)}))})}attributeChangedCallback(t,e,s){switch(t){case"src":this.src&&s&&s!==e&&!this.isNew&&Ue(this.src,this.authorization).then(r=>{this._state=r,$t(r,this)});break;case"new":s&&(this._state={},$t({},this));break}}};He.observedAttributes=["src","new","action"];He.template=zt`
    <template>
      <form autocomplete="off">
        <slot></slot>
        <slot name="submit">
  ...
  `;let Zs=He;function Ue(i,t){return fetch(i,{headers:t}).then(e=>{if(e.status!==200)throw`Status: ${e.status}`;return e.json()}).catch(e=>console.log(`Failed to load form from ${i}:`,e))}function $t(i,t){const e=Object.entries(i);for(const[s,r]of e){const o=t.querySelector(`[name="${s}"]`);if(o){const a=o;switch(a.type){case"checkbox":const n=a;n.checked=!!r;break;default:a.value=r;break}}}return i}function Xs(i,t,e="PUT",s={}){return fetch(i,{method:e,headers:{"Content-Type":"application/json",...s},body:JSON.stringify(t)}).then(r=>{if(r.status!=200&&r.status!=201)throw`Form submission failed: Status ${r.status}`;return r.json()})}const Zr=Object.freeze(Object.defineProperty({__proto__:null,FormElement:Zs,fetchData:Ue},Symbol.toStringTag,{value:"Module"})),Xr=class Vr extends De{constructor(t,e){super(e,t,Vr.EVENT_TYPE,!1)}};Xr.EVENT_TYPE="mu:message";let ts=Xr;class Vs extends ze{constructor(t,e,s){super(e),this._user=new ht,this._updateFn=t,this._authObserver=new T(this,s)}connectedCallback(){const t=new ts(this.context,(e,s)=>this._updateFn(e,s,this._user));t.attach(this),this._authObserver.observe(({user:e})=>{console.log("Store got auth",e),e&&(this._user=e),t.start()})}}const ti=Object.freeze(Object.defineProperty({__proto__:null,Provider:Vs,Service:ts},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wt=globalThis,Be=Wt.ShadowRoot&&(Wt.ShadyCSS===void 0||Wt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Qe=Symbol(),gr=new WeakMap;let es=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==Qe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(Be&&t===void 0){const s=e!==void 0&&e.length===1;s&&(t=gr.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&gr.set(e,t))}return t}toString(){return this.cssText}};const ei=i=>new es(typeof i=="string"?i:i+"",void 0,Qe),ri=(i,...t)=>{const e=i.length===1?i[0]:t.reduce((s,r,o)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+i[o+1],i[0]);return new es(e,i,Qe)},si=(i,t)=>{if(Be)i.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const s=document.createElement("style"),r=Wt.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=e.cssText,i.appendChild(s)}},fr=Be?i=>i:i=>i instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return ei(e)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:ii,defineProperty:oi,getOwnPropertyDescriptor:ai,getOwnPropertyNames:ni,getOwnPropertySymbols:li,getPrototypeOf:ci}=Object,gt=globalThis,mr=gt.trustedTypes,di=mr?mr.emptyScript:"",vr=gt.reactiveElementPolyfillSupport,At=(i,t)=>i,Yt={toAttribute(i,t){switch(t){case Boolean:i=i?di:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,t){let e=i;switch(t){case Boolean:e=i!==null;break;case Number:e=i===null?null:Number(i);break;case Object:case Array:try{e=JSON.parse(i)}catch{e=null}}return e}},We=(i,t)=>!ii(i,t),yr={attribute:!0,type:String,converter:Yt,reflect:!1,hasChanged:We};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),gt.litPropertyMetadata??(gt.litPropertyMetadata=new WeakMap);let ct=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=yr){if(e.state&&(e.attribute=!1),this._$Ei(),this.elementProperties.set(t,e),!e.noAccessor){const s=Symbol(),r=this.getPropertyDescriptor(t,s,e);r!==void 0&&oi(this.prototype,t,r)}}static getPropertyDescriptor(t,e,s){const{get:r,set:o}=ai(this.prototype,t)??{get(){return this[e]},set(a){this[e]=a}};return{get(){return r==null?void 0:r.call(this)},set(a){const n=r==null?void 0:r.call(this);o.call(this,a),this.requestUpdate(t,n,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??yr}static _$Ei(){if(this.hasOwnProperty(At("elementProperties")))return;const t=ci(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(At("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(At("properties"))){const e=this.properties,s=[...ni(e),...li(e)];for(const r of s)this.createProperty(r,e[r])}const t=this[Symbol.metadata];if(t!==null){const e=litPropertyMetadata.get(t);if(e!==void 0)for(const[s,r]of e)this.elementProperties.set(s,r)}this._$Eh=new Map;for(const[e,s]of this.elementProperties){const r=this._$Eu(e,s);r!==void 0&&this._$Eh.set(r,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const r of s)e.unshift(fr(r))}else t!==void 0&&e.push(fr(t));return e}static _$Eu(t,e){const s=e.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(e=>e(this))}addController(t){var e;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((e=t.hostConnected)==null||e.call(t))}removeController(t){var e;(e=this._$EO)==null||e.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return si(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(e=>{var s;return(s=e.hostConnected)==null?void 0:s.call(e)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(e=>{var s;return(s=e.hostDisconnected)==null?void 0:s.call(e)})}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$EC(t,e){var s;const r=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,r);if(o!==void 0&&r.reflect===!0){const a=(((s=r.converter)==null?void 0:s.toAttribute)!==void 0?r.converter:Yt).toAttribute(e,r.type);this._$Em=t,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$Em=null}}_$AK(t,e){var s;const r=this.constructor,o=r._$Eh.get(t);if(o!==void 0&&this._$Em!==o){const a=r.getPropertyOptions(o),n=typeof a.converter=="function"?{fromAttribute:a.converter}:((s=a.converter)==null?void 0:s.fromAttribute)!==void 0?a.converter:Yt;this._$Em=o,this[o]=n.fromAttribute(e,a.type),this._$Em=null}}requestUpdate(t,e,s){if(t!==void 0){if(s??(s=this.constructor.getPropertyOptions(t)),!(s.hasChanged??We)(this[t],e))return;this.P(t,e,s)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(t,e,s){this._$AL.has(t)||this._$AL.set(t,e),s.reflect===!0&&this._$Em!==t&&(this._$Ej??(this._$Ej=new Set)).add(t)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[o,a]of this._$Ep)this[o]=a;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[o,a]of r)a.wrapped!==!0||this._$AL.has(o)||this[o]===void 0||this.P(o,this[o],a)}let e=!1;const s=this._$AL;try{e=this.shouldUpdate(s),e?(this.willUpdate(s),(t=this._$EO)==null||t.forEach(r=>{var o;return(o=r.hostUpdate)==null?void 0:o.call(r)}),this.update(s)):this._$EU()}catch(r){throw e=!1,this._$EU(),r}e&&this._$AE(s)}willUpdate(t){}_$AE(t){var e;(e=this._$EO)==null||e.forEach(s=>{var r;return(r=s.hostUpdated)==null?void 0:r.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Ej&&(this._$Ej=this._$Ej.forEach(e=>this._$EC(e,this[e]))),this._$EU()}updated(t){}firstUpdated(t){}};ct.elementStyles=[],ct.shadowRootOptions={mode:"open"},ct[At("elementProperties")]=new Map,ct[At("finalized")]=new Map,vr==null||vr({ReactiveElement:ct}),(gt.reactiveElementVersions??(gt.reactiveElementVersions=[])).push("2.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Kt=globalThis,Zt=Kt.trustedTypes,br=Zt?Zt.createPolicy("lit-html",{createHTML:i=>i}):void 0,rs="$lit$",N=`lit$${Math.random().toFixed(9).slice(2)}$`,ss="?"+N,pi=`<${ss}>`,K=document,Pt=()=>K.createComment(""),Ot=i=>i===null||typeof i!="object"&&typeof i!="function",is=Array.isArray,hi=i=>is(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",ke=`[ 	
\f\r]`,xt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,wr=/-->/g,$r=/>/g,W=RegExp(`>|${ke}(?:([^\\s"'>=/]+)(${ke}*=${ke}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),xr=/'/g,_r=/"/g,os=/^(?:script|style|textarea|title)$/i,ui=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),_t=ui(1),ft=Symbol.for("lit-noChange"),k=Symbol.for("lit-nothing"),Sr=new WeakMap,J=K.createTreeWalker(K,129);function as(i,t){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return br!==void 0?br.createHTML(t):t}const gi=(i,t)=>{const e=i.length-1,s=[];let r,o=t===2?"<svg>":"",a=xt;for(let n=0;n<e;n++){const l=i[n];let g,f,h=-1,c=0;for(;c<l.length&&(a.lastIndex=c,f=a.exec(l),f!==null);)c=a.lastIndex,a===xt?f[1]==="!--"?a=wr:f[1]!==void 0?a=$r:f[2]!==void 0?(os.test(f[2])&&(r=RegExp("</"+f[2],"g")),a=W):f[3]!==void 0&&(a=W):a===W?f[0]===">"?(a=r??xt,h=-1):f[1]===void 0?h=-2:(h=a.lastIndex-f[2].length,g=f[1],a=f[3]===void 0?W:f[3]==='"'?_r:xr):a===_r||a===xr?a=W:a===wr||a===$r?a=xt:(a=W,r=void 0);const p=a===W&&i[n+1].startsWith("/>")?" ":"";o+=a===xt?l+pi:h>=0?(s.push(g),l.slice(0,h)+rs+l.slice(h)+N+p):l+N+(h===-2?n:p)}return[as(i,o+(i[e]||"<?>")+(t===2?"</svg>":"")),s]};let Ie=class ns{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let o=0,a=0;const n=t.length-1,l=this.parts,[g,f]=gi(t,e);if(this.el=ns.createElement(g,s),J.currentNode=this.el.content,e===2){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(r=J.nextNode())!==null&&l.length<n;){if(r.nodeType===1){if(r.hasAttributes())for(const h of r.getAttributeNames())if(h.endsWith(rs)){const c=f[a++],p=r.getAttribute(h).split(N),u=/([.?@])?(.*)/.exec(c);l.push({type:1,index:o,name:u[2],strings:p,ctor:u[1]==="."?mi:u[1]==="?"?vi:u[1]==="@"?yi:he}),r.removeAttribute(h)}else h.startsWith(N)&&(l.push({type:6,index:o}),r.removeAttribute(h));if(os.test(r.tagName)){const h=r.textContent.split(N),c=h.length-1;if(c>0){r.textContent=Zt?Zt.emptyScript:"";for(let p=0;p<c;p++)r.append(h[p],Pt()),J.nextNode(),l.push({type:2,index:++o});r.append(h[c],Pt())}}}else if(r.nodeType===8)if(r.data===ss)l.push({type:2,index:o});else{let h=-1;for(;(h=r.data.indexOf(N,h+1))!==-1;)l.push({type:7,index:o}),h+=N.length-1}o++}}static createElement(t,e){const s=K.createElement("template");return s.innerHTML=t,s}};function mt(i,t,e=i,s){var r,o;if(t===ft)return t;let a=s!==void 0?(r=e._$Co)==null?void 0:r[s]:e._$Cl;const n=Ot(t)?void 0:t._$litDirective$;return(a==null?void 0:a.constructor)!==n&&((o=a==null?void 0:a._$AO)==null||o.call(a,!1),n===void 0?a=void 0:(a=new n(i),a._$AT(i,e,s)),s!==void 0?(e._$Co??(e._$Co=[]))[s]=a:e._$Cl=a),a!==void 0&&(t=mt(i,a._$AS(i,t.values),a,s)),t}let fi=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,r=((t==null?void 0:t.creationScope)??K).importNode(e,!0);J.currentNode=r;let o=J.nextNode(),a=0,n=0,l=s[0];for(;l!==void 0;){if(a===l.index){let g;l.type===2?g=new Ge(o,o.nextSibling,this,t):l.type===1?g=new l.ctor(o,l.name,l.strings,this,t):l.type===6&&(g=new bi(o,this,t)),this._$AV.push(g),l=s[++n]}a!==(l==null?void 0:l.index)&&(o=J.nextNode(),a++)}return J.currentNode=K,r}p(t){let e=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},Ge=class ls{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,s,r){this.type=2,this._$AH=k,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this._$Cv=(r==null?void 0:r.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=mt(this,t,e),Ot(t)?t===k||t==null||t===""?(this._$AH!==k&&this._$AR(),this._$AH=k):t!==this._$AH&&t!==ft&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):hi(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==k&&Ot(this._$AH)?this._$AA.nextSibling.data=t:this.T(K.createTextNode(t)),this._$AH=t}$(t){var e;const{values:s,_$litType$:r}=t,o=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=Ie.createElement(as(r.h,r.h[0]),this.options)),r);if(((e=this._$AH)==null?void 0:e._$AD)===o)this._$AH.p(s);else{const a=new fi(o,this),n=a.u(this.options);a.p(s),this.T(n),this._$AH=a}}_$AC(t){let e=Sr.get(t.strings);return e===void 0&&Sr.set(t.strings,e=new Ie(t)),e}k(t){is(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,r=0;for(const o of t)r===e.length?e.push(s=new ls(this.S(Pt()),this.S(Pt()),this,this.options)):s=e[r],s._$AI(o),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,e);t&&t!==this._$AB;){const r=t.nextSibling;t.remove(),t=r}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}},he=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,o){this.type=1,this._$AH=k,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=k}_$AI(t,e=this,s,r){const o=this.strings;let a=!1;if(o===void 0)t=mt(this,t,e,0),a=!Ot(t)||t!==this._$AH&&t!==ft,a&&(this._$AH=t);else{const n=t;let l,g;for(t=o[0],l=0;l<o.length-1;l++)g=mt(this,n[s+l],e,l),g===ft&&(g=this._$AH[l]),a||(a=!Ot(g)||g!==this._$AH[l]),g===k?t=k:t!==k&&(t+=(g??"")+o[l+1]),this._$AH[l]=g}a&&!r&&this.j(t)}j(t){t===k?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},mi=class extends he{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===k?void 0:t}},vi=class extends he{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==k)}},yi=class extends he{constructor(t,e,s,r,o){super(t,e,s,r,o),this.type=5}_$AI(t,e=this){if((t=mt(this,t,e,0)??k)===ft)return;const s=this._$AH,r=t===k&&s!==k||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==k&&(s===k||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}},bi=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){mt(this,t)}};const kr=Kt.litHtmlPolyfillSupport;kr==null||kr(Ie,Ge),(Kt.litHtmlVersions??(Kt.litHtmlVersions=[])).push("3.1.3");const wi=(i,t,e)=>{const s=(e==null?void 0:e.renderBefore)??t;let r=s._$litPart$;if(r===void 0){const o=(e==null?void 0:e.renderBefore)??null;s._$litPart$=r=new Ge(t.insertBefore(Pt(),o),o,void 0,e??{})}return r._$AI(i),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+this.showPosition(),{text:"",token:null,line:this.yylineno})},lex:function(){var p=this.next();return p||this.lex()},begin:function(p){this.conditionStack.push(p)},popState:function(){var p=this.conditionStack.length-1;return p>0?this.conditionStack.pop():this.conditionStack[0]},_currentRules:function(){return this.conditionStack.length&&this.conditionStack[this.conditionStack.length-1]?this.conditions[this.conditionStack[this.conditionStack.length-1]].rules:this.conditions.INITIAL.rules},topState:function(p){return p=this.conditionStack.length-1-Math.abs(p||0),p>=0?this.conditionStack[p]:"INITIAL"},pushState:function(p){this.begin(p)},stateStackSize:function(){return this.conditionStack.length},options:{},performAction:function(p,u,v,m){switch(v){case 0:return"(";case 1:return")";case 2:return"SPLAT";case 3:return"PARAM";case 4:return"LITERAL";case 5:return"LITERAL";case 6:return"EOF"}},rules:[/^(?:\()/,/^(?:\))/,/^(?:\*+\w+)/,/^(?::+\w+)/,/^(?:[\w%\-~\n]+)/,/^(?:.)/,/^(?:$)/],conditions:{INITIAL:{rules:[0,1,2,3,4,5,6],inclusive:!0}}};return h}();l.lexer=g;function f(){this.yy={}}return f.prototype=l,l.Parser=f,new f}();typeof Si<"u"&&(i.parser=t,i.Parser=t.Parser,i.parse=function(){return t.parse.apply(t,arguments)})})(ps);function lt(i){return function(t,e){return{displayName:i,props:t,children:e||[]}}}var hs={Root:lt("Root"),Concat:lt("Concat"),Literal:lt("Literal"),Splat:lt("Splat"),Param:lt("Param"),Optional:lt("Optional")},us=ps.parser;us.yy=hs;var ki=us,Ai=Object.keys(hs);function Ei(i){return Ai.forEach(function(t){if(typeof i[t]>"u")throw new Error("No handler defined for "+t.displayName)}),{visit:function(t,e){return this.handlers[t.displayName].call(this,t,e)},handlers:i}}var gs=Ei,Ri=gs,Pi=/[\-{}\[\]+?.,\\\^$|#\s]/g;function fs(i){this.captures=i.captures,this.re=i.re}fs.prototype.match=function(i){var t=this.re.exec(i),e={};if(t)return this.captures.forEach(function(s,r){typeof t[r+1]>"u"?e[s]=void 0:e[s]=decodeURIComponent(t[r+1])}),e};var Oi=Ri({Concat:function(i){return i.children.reduce((function(t,e){var s=this.visit(e);return{re:t.re+s.re,captures:t.captures.concat(s.captures)}}).bind(this),{re:"",captures:[]})},Literal:function(i){return{re:i.props.value.replace(Pi,"\\$&"),captures:[]}},Splat:function(i){return{re:"([^?]*?)",captures:[i.props.name]}},Param:function(i){return{re:"([^\\/\\?]+)",captures:[i.props.name]}},Optional:function(i){var t=this.visit(i.children[0]);return{re:"(?:"+t.re+")?",captures:t.captures}},Root:function(i){var t=this.visit(i.children[0]);return new fs({re:new RegExp("^"+t.re+"(?=\\?|$)"),captures:t.captures})}}),Ci=Oi,Ti=gs,Ui=Ti({Concat:function(i,t){var e=i.children.map((function(s){return this.visit(s,t)}).bind(this));return e.some(function(s){return s===!1})?!1:e.join("")},Literal:function(i){return decodeURI(i.props.value)},Splat:function(i,t){return t[i.props.name]?t[i.props.name]:!1},Param:function(i,t){return t[i.props.name]?t[i.props.name]:!1},Optional:function(i,t){var e=this.visit(i.children[0],t);return e||""},Root:function(i,t){t=t||{};var e=this.visit(i.children[0],t);return e?encodeURI(e):!1}}),Ii=Ui,Li=ki,ji=Ci,Mi=Ii;Dt.prototype=Object.create(null);Dt.prototype.match=function(i){var t=ji.visit(this.ast),e=t.match(i);return e||!1};Dt.prototype.reverse=function(i){return Mi.visit(this.ast,i)};function Dt(i){var t;if(this?t=this:t=Object.create(Dt.prototype),typeof i>"u")throw new Error("A route spec is required");return t.spec=i,t.ast=Li.parse(i),t}var zi=Dt,Di=zi,Ni=Di;const Fi=_i(Ni);var qi=Object.defineProperty,Hi=Object.getOwnPropertyDescriptor,ms=(i,t,e,s)=>{for(var r=s>1?void 0:s?Hi(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&qi(t,e,r),r};class Ct extends pt{constructor(t,e,s=""){super(),this._cases=[],this._fallback=()=>_t`
      <h1>Not Found</h1>
    `,this._cases=t.map(r=>({...r,route:new Fi(r.path)})),this._historyObserver=new T(this,e),this._authObserver=new T(this,s)}connectedCallback(){this._historyObserver.observe(({location:t})=>{console.log("New location",t),t&&(this._match=this.matchRoute(t))}),this._authObserver.observe(({user:t})=>{this._user=t}),super.connectedCallback()}render(){return console.log("Rendering for match",this._match,this._user),_t`
    ...
    `}updated(t){t.has("_match")&&this.requestUpdate()}matchRoute(t){const{search:e,pathname:s}=t,r=new URLSearchParams(e),o=s+e;for(const a of this._cases){const n=a.route.match(o);if(n)return{...a,path:s,params:n,query:r}}}redirect(t){qe(this,"history/redirect",{href:t})}}Ct.styles=ri`
    :host,
    main {
      display: contents;
    }
  `;ms([ds()],Ct.prototype,"_user",2);ms([ds()],Ct.prototype,"_match",2);const Bi=Object.freeze(Object.defineProperty({__proto__:null,Element:Ct,Switch:Ct},Symbol.toStringTag,{value:"Module"})),Qi=class vs extends HTMLElement{constructor(){if(super(),pe(vs.template).attach(this),this.shadowRoot){const t=this.shadowRoot.querySelector("slot[name='actuator']");t&&t.addEventListener("click",()=>this.toggle())}}toggle(){this.hasAttribute("open")?this.removeAttribute("open"):this.setAttribute("open","open")}};Qi.template=zt`
    <template>
  ...
  `;const Wi=class ys extends HTMLElement{constructor(){super(),this._array=[],pe(ys.template).attach(this),this.addEventListener("input-array:add",t=>{t.stopPropagation(),this.append(bs("",this._array.length))}),this.addEventListener("input-array:remove",t=>{t.stopPropagation(),this.removeClosestItem(t.target)}),this.addEventListener("change",t=>{t.stopPropagation();const e=t.target;if(e&&e!==this){const s=new Event("change",{bubbles:!0}),r=e.value,o=e.closest("label");if(o){const a=Array.from(this.children).indexOf(o);this._array[a]=r,this.dispatchEvent(s)}}}),this.addEventListener("click",t=>{Te(t,"button.add")?Jt(t,"input-array:add"):Te(t,"button.remove")&&Jt(t,"input-array:remove")})}get name(){return this.getAttribute("name")}get value(){return this._array}set value(t){this._array=Array.isArray(t)?t:[t],Gi(this._array,this)}removeClosestItem(t){const e=t.closest("label");if(console.log("Removing closest item:",e,t),e){const s=Array.from(this.children).indexOf(e);this._array.splice(s,1),e.remove()}}};Wi.template=zt`
    <template>
      <ul>
        <slot></slot>
      </ul>
  ...
  `;function Gi(i,t){t.replaceChildren(),i.forEach((e,s)=>t.append(bs(e)))}function bs(i,t){const e=i===void 0?"":`value="${i}"`;return zt`
    <label>
      <input ${e} />
      <button class="remove" type="button">Remove</button>
    </label>
  `}function U(i){return Object.entries(i).map(([t,e])=>{customElements.get(t)||customElements.define(t,e)}),customElements}var Ji=Object.defineProperty,Yi=Object.getOwnPropertyDescriptor,Ki=(i,t,e,s)=>{for(var r=s>1?void 0:s?Yi(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&Ji(t,e,r),r};class j extends pt{constructor(t){super(),this._pending=[],this._observer=new T(this,t)}get model(){return this._lastModel=this._context?this._context.value:{},this._lastModel}connectedCallback(){var t;super.connectedCallback(),(t=this._observer)==null||t.observe().then(e=>{console.log("View effect (initial)",this,e),this._context=e.context,this._pending.length&&this._pending.forEach(([s,r])=>{console.log("Dispatching queued event",r,s),s.dispatchEvent(r)}),e.setEffect(()=>{var s;if(console.log("View effect",this,e,(s=this._context)==null?void 0:s.value),this._context)console.log("requesting update"),this.requestUpdate();else throw"View context not ready for effect"})})}dispatchMessage(t,e=this){const s=new CustomEvent("mu:message",{bubbles:!0,composed:!0,detail:t});this._context?(console.log("Dispatching message event",s),e.dispatchEvent(s)):(console.log("Queueing message event",s),this._pending.push([e,s]))}ref(t){return this.model?this.model[t]:void 0}}Ki([cs()],j.prototype,"model",1);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gt=globalThis,Je=Gt.ShadowRoot&&(Gt.ShadyCSS===void 0||Gt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ye=Symbol(),Er=new WeakMap;let ws=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==Ye)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(Je&&t===void 0){const s=e!==void 0&&e.length===1;s&&(t=Er.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&Er.set(e,t))}return t}toString(){return this.cssText}};const Zi=i=>new ws(typeof i=="string"?i:i+"",void 0,Ye),x=(i,...t)=>{const e=i.length===1?i[0]:t.reduce((s,r,o)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+i[o+1],i[0]);return new ws(e,i,Ye)},Xi=(i,t)=>{if(Je)i.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const s=document.createElement("style"),r=Gt.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=e.cssText,i.appendChild(s)}},Rr=Je?i=>i:i=>i instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return Zi(e)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Vi,defineProperty:to,getOwnPropertyDescriptor:eo,getOwnPropertyNames:ro,getOwnPropertySymbols:so,getPrototypeOf:io}=Object,q=globalThis,Pr=q.trustedTypes,oo=Pr?Pr.emptyScript:"",Ae=q.reactiveElementPolyfillSupport,Et=(i,t)=>i,Xt={toAttribute(i,t){switch(t){case Boolean:i=i?oo:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,t){let e=i;switch(t){case Boolean:e=i!==null;break;case Number:e=i===null?null:Number(i);break;case Object:case Array:try{e=JSON.parse(i)}catch{e=null}}return e}},Ke=(i,t)=>!Vi(i,t),Or={attribute:!0,type:String,converter:Xt,reflect:!1,hasChanged:Ke};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),q.litPropertyMetadata??(q.litPropertyMetadata=new WeakMap);class dt extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Or){if(e.state&&(e.attribute=!1),this._$Ei(),this.elementProperties.set(t,e),!e.noAccessor){const s=Symbol(),r=this.getPropertyDescriptor(t,s,e);r!==void 0&&to(this.prototype,t,r)}}static getPropertyDescriptor(t,e,s){const{get:r,set:o}=eo(this.prototype,t)??{get(){return this[e]},set(a){this[e]=a}};return{get(){return r==null?void 0:r.call(this)},set(a){const n=r==null?void 0:r.call(this);o.call(this,a),this.requestUpdate(t,n,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Or}static _$Ei(){if(this.hasOwnProperty(Et("elementProperties")))return;const t=io(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Et("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Et("properties"))){const e=this.properties,s=[...ro(e),...so(e)];for(const r of s)this.createProperty(r,e[r])}const t=this[Symbol.metadata];if(t!==null){const e=litPropertyMetadata.get(t);if(e!==void 0)for(const[s,r]of e)this.elementProperties.set(s,r)}this._$Eh=new Map;for(const[e,s]of this.elementProperties){const r=this._$Eu(e,s);r!==void 0&&this._$Eh.set(r,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const r of s)e.unshift(Rr(r))}else t!==void 0&&e.push(Rr(t));return e}static _$Eu(t,e){const s=e.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(e=>e(this))}addController(t){var e;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((e=t.hostConnected)==null||e.call(t))}removeController(t){var e;(e=this._$EO)==null||e.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Xi(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(e=>{var s;return(s=e.hostConnected)==null?void 0:s.call(e)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(e=>{var s;return(s=e.hostDisconnected)==null?void 0:s.call(e)})}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$EC(t,e){var o;const s=this.constructor.elementProperties.get(t),r=this.constructor._$Eu(t,s);if(r!==void 0&&s.reflect===!0){const a=(((o=s.converter)==null?void 0:o.toAttribute)!==void 0?s.converter:Xt).toAttribute(e,s.type);this._$Em=t,a==null?this.removeAttribute(r):this.setAttribute(r,a),this._$Em=null}}_$AK(t,e){var o;const s=this.constructor,r=s._$Eh.get(t);if(r!==void 0&&this._$Em!==r){const a=s.getPropertyOptions(r),n=typeof a.converter=="function"?{fromAttribute:a.converter}:((o=a.converter)==null?void 0:o.fromAttribute)!==void 0?a.converter:Xt;this._$Em=r,this[r]=n.fromAttribute(e,a.type),this._$Em=null}}requestUpdate(t,e,s){if(t!==void 0){if(s??(s=this.constructor.getPropertyOptions(t)),!(s.hasChanged??Ke)(this[t],e))return;this.P(t,e,s)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(t,e,s){this._$AL.has(t)||this._$AL.set(t,e),s.reflect===!0&&this._$Em!==t&&(this._$Ej??(this._$Ej=new Set)).add(t)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[o,a]of this._$Ep)this[o]=a;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[o,a]of r)a.wrapped!==!0||this._$AL.has(o)||this[o]===void 0||this.P(o,this[o],a)}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),(s=this._$EO)==null||s.forEach(r=>{var o;return(o=r.hostUpdate)==null?void 0:o.call(r)}),this.update(e)):this._$EU()}catch(r){throw t=!1,this._$EU(),r}t&&this._$AE(e)}willUpdate(t){}_$AE(t){var e;(e=this._$EO)==null||e.forEach(s=>{var r;return(r=s.hostUpdated)==null?void 0:r.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Ej&&(this._$Ej=this._$Ej.forEach(e=>this._$EC(e,this[e]))),this._$EU()}updated(t){}firstUpdated(t){}}dt.elementStyles=[],dt.shadowRootOptions={mode:"open"},dt[Et("elementProperties")]=new Map,dt[Et("finalized")]=new Map,Ae==null||Ae({ReactiveElement:dt}),(q.reactiveElementVersions??(q.reactiveElementVersions=[])).push("2.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Rt=globalThis,Vt=Rt.trustedTypes,Cr=Vt?Vt.createPolicy("lit-html",{createHTML:i=>i}):void 0,$s="$lit$",F=`lit$${Math.random().toFixed(9).slice(2)}$`,xs="?"+F,ao=`<${xs}>`,Z=document,Tt=()=>Z.createComment(""),Ut=i=>i===null||typeof i!="object"&&typeof i!="function",_s=Array.isArray,no=i=>_s(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",Ee=`[ 	
\f\r]`,St=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Tr=/-->/g,Ur=/>/g,G=RegExp(`>|${Ee}(?:([^\\s"'>=/]+)(${Ee}*=${Ee}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ir=/'/g,Lr=/"/g,Ss=/^(?:script|style|textarea|title)$/i,lo=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),d=lo(1),vt=Symbol.for("lit-noChange"),A=Symbol.for("lit-nothing"),jr=new WeakMap,Y=Z.createTreeWalker(Z,129);function ks(i,t){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Cr!==void 0?Cr.createHTML(t):t}const co=(i,t)=>{const e=i.length-1,s=[];let r,o=t===2?"<svg>":"",a=St;for(let n=0;n<e;n++){const l=i[n];let g,f,h=-1,c=0;for(;c<l.length&&(a.lastIndex=c,f=a.exec(l),f!==null);)c=a.lastIndex,a===St?f[1]==="!--"?a=Tr:f[1]!==void 0?a=Ur:f[2]!==void 0?(Ss.test(f[2])&&(r=RegExp("</"+f[2],"g")),a=G):f[3]!==void 0&&(a=G):a===G?f[0]===">"?(a=r??St,h=-1):f[1]===void 0?h=-2:(h=a.lastIndex-f[2].length,g=f[1],a=f[3]===void 0?G:f[3]==='"'?Lr:Ir):a===Lr||a===Ir?a=G:a===Tr||a===Ur?a=St:(a=G,r=void 0);const p=a===G&&i[n+1].startsWith("/>")?" ":"";o+=a===St?l+ao:h>=0?(s.push(g),l.slice(0,h)+$s+l.slice(h)+F+p):l+F+(h===-2?n:p)}return[ks(i,o+(i[e]||"<?>")+(t===2?"</svg>":"")),s]};class It{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let o=0,a=0;const n=t.length-1,l=this.parts,[g,f]=co(t,e);if(this.el=It.createElement(g,s),Y.currentNode=this.el.content,e===2){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(r=Y.nextNode())!==null&&l.length<n;){if(r.nodeType===1){if(r.hasAttributes())for(const h of r.getAttributeNames())if(h.endsWith($s)){const c=f[a++],p=r.getAttribute(h).split(F),u=/([.?@])?(.*)/.exec(c);l.push({type:1,index:o,name:u[2],strings:p,ctor:u[1]==="."?ho:u[1]==="?"?uo:u[1]==="@"?go:ue}),r.removeAttribute(h)}else h.startsWith(F)&&(l.push({type:6,index:o}),r.removeAttribute(h));if(Ss.test(r.tagName)){const h=r.textContent.split(F),c=h.length-1;if(c>0){r.textContent=Vt?Vt.emptyScript:"";for(let p=0;p<c;p++)r.append(h[p],Tt()),Y.nextNode(),l.push({type:2,index:++o});r.append(h[c],Tt())}}}else if(r.nodeType===8)if(r.data===xs)l.push({type:2,index:o});else{let h=-1;for(;(h=r.data.indexOf(F,h+1))!==-1;)l.push({type:7,index:o}),h+=F.length-1}o++}}static createElement(t,e){const s=Z.createElement("template");return s.innerHTML=t,s}}function yt(i,t,e=i,s){var a,n;if(t===vt)return t;let r=s!==void 0?(a=e._$Co)==null?void 0:a[s]:e._$Cl;const o=Ut(t)?void 0:t._$litDirective$;return(r==null?void 0:r.constructor)!==o&&((n=r==null?void 0:r._$AO)==null||n.call(r,!1),o===void 0?r=void 0:(r=new o(i),r._$AT(i,e,s)),s!==void 0?(e._$Co??(e._$Co=[]))[s]=r:e._$Cl=r),r!==void 0&&(t=yt(i,r._$AS(i,t.values),r,s)),t}class po{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,r=((t==null?void 0:t.creationScope)??Z).importNode(e,!0);Y.currentNode=r;let o=Y.nextNode(),a=0,n=0,l=s[0];for(;l!==void 0;){if(a===l.index){let g;l.type===2?g=new Nt(o,o.nextSibling,this,t):l.type===1?g=new l.ctor(o,l.name,l.strings,this,t):l.type===6&&(g=new fo(o,this,t)),this._$AV.push(g),l=s[++n]}a!==(l==null?void 0:l.index)&&(o=Y.nextNode(),a++)}return Y.currentNode=Z,r}p(t){let e=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class Nt{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,s,r){this.type=2,this._$AH=A,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this._$Cv=(r==null?void 0:r.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=yt(this,t,e),Ut(t)?t===A||t==null||t===""?(this._$AH!==A&&this._$AR(),this._$AH=A):t!==this._$AH&&t!==vt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):no(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==A&&Ut(this._$AH)?this._$AA.nextSibling.data=t:this.T(Z.createTextNode(t)),this._$AH=t}$(t){var o;const{values:e,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=It.createElement(ks(s.h,s.h[0]),this.options)),s);if(((o=this._$AH)==null?void 0:o._$AD)===r)this._$AH.p(e);else{const a=new po(r,this),n=a.u(this.options);a.p(e),this.T(n),this._$AH=a}}_$AC(t){let e=jr.get(t.strings);return e===void 0&&jr.set(t.strings,e=new It(t)),e}k(t){_s(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,r=0;for(const o of t)r===e.length?e.push(s=new Nt(this.S(Tt()),this.S(Tt()),this,this.options)):s=e[r],s._$AI(o),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,e);t&&t!==this._$AB;){const r=t.nextSibling;t.remove(),t=r}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}}class ue{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,o){this.type=1,this._$AH=A,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A}_$AI(t,e=this,s,r){const o=this.strings;let a=!1;if(o===void 0)t=yt(this,t,e,0),a=!Ut(t)||t!==this._$AH&&t!==vt,a&&(this._$AH=t);else{const n=t;let l,g;for(t=o[0],l=0;l<o.length-1;l++)g=yt(this,n[s+l],e,l),g===vt&&(g=this._$AH[l]),a||(a=!Ut(g)||g!==this._$AH[l]),g===A?t=A:t!==A&&(t+=(g??"")+o[l+1]),this._$AH[l]=g}a&&!r&&this.j(t)}j(t){t===A?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class ho extends ue{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===A?void 0:t}}class uo extends ue{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==A)}}class go extends ue{constructor(t,e,s,r,o){super(t,e,s,r,o),this.type=5}_$AI(t,e=this){if((t=yt(this,t,e,0)??A)===vt)return;const s=this._$AH,r=t===A&&s!==A||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==A&&(s===A||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}}class fo{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){yt(this,t)}}const Re=Rt.litHtmlPolyfillSupport;Re==null||Re(It,Nt),(Rt.litHtmlVersions??(Rt.litHtmlVersions=[])).push("3.1.3");const mo=(i,t,e)=>{const s=(e==null?void 0:e.renderBefore)??t;let r=s._$litPart$;if(r===void 0){const o=(e==null?void 0:e.renderBefore)??null;s._$litPart$=r=new Nt(t.insertBefore(Tt(),o),o,void 0,e??{})}return r._$AI(i),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class R extends dt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=mo(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return vt}}var Mr;R._$litElement$=!0,R.finalized=!0,(Mr=globalThis.litElementHydrateSupport)==null||Mr.call(globalThis,{LitElement:R});const Pe=globalThis.litElementPolyfillSupport;Pe==null||Pe({LitElement:R});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.0.5");const vo={};function yo(i,t,e){switch(i[0]){case"profile/save":bo(i[1],e).then(r=>t(o=>({...o,profile:r}))).then(()=>{const{onSuccess:r}=i[1];r&&r()}).catch(r=>{const{onFailure:o}=i[1];o&&o(r)});break;case"profile/select":wo(i[1],e).then(r=>t(o=>({...o,profile:r})));break;case"study-spot/index":$o().then(r=>t(o=>({...o,studySpotIndex:r}))).catch(r=>{console.error("Failed to fetch study spots",r)});break;case"study-spot/select":xo(i[1]).then(r=>t(o=>({...o,studySpot:r})));break;case"study-spot/add":_o(i[1],e).then(r=>t(o=>({...o,studySpot:r}))).then(()=>{const{onSuccess:r}=i[1];r&&r()}).catch(r=>{const{onFailure:o}=i[1];o&&o(r)});break;case"study-spot/update":So({spotid:i[1].spotid,ratings:i[1].rating,reviewsCount:i[1].reviewsCount},e).then(r=>t(o=>({...o,studySpot:r}))).then(()=>{const{onSuccess:r}=i[1];r&&r()}).catch(r=>{const{onFailure:o}=i[1];o&&o(r)});break;case"review/list-by-spot":ko(i[1].spotId).then(r=>t(o=>({...o,reviews:r})));break;case"review/list-by-user":Oo(i[1].userId).then(r=>t(o=>({...o,reviews:r})));break;case"review/add":Ao(i[1],e).then(r=>{r&&t(o=>({...o,reviews:[...o.reviews??[],r]}))}).then(()=>{const{onSuccess:r}=i[1];r&&r()}).catch(r=>{const{onFailure:o}=i[1];o&&o(r)});break;case"review/delete":Eo(i[1].reviewId).then(()=>{t(r=>{var o;return{...r,reviews:(o=r.reviews)==null?void 0:o.filter(a=>a._id!==i[1].reviewId)}})}).then(()=>{const{onSuccess:r}=i[1];r&&r()}).catch(r=>{const{onFailure:o}=i[1];o&&o(r)});break;case"review/update":Ro(i[1].review,e).then(r=>{r&&t(o=>{var a;return{...o,reviews:(a=o.reviews)==null?void 0:a.map(n=>n._id===r._id?r:n)}})}).then(()=>{const{onSuccess:r}=i[1];r&&r()}).catch(r=>{const{onFailure:o}=i[1];o&&o(r)});break;case"review/select":Po(i[1]).then(r=>t(o=>({...o,review:r})));break;case"review/clear":t(r=>({...r,reviews:[]}));break;default:const s=i[0];throw new Error(`Unhandled message "${s}"`)}}function bo(i,t){return fetch(`/api/profiles/${i.userid}`,{method:"PUT",headers:{"Content-Type":"application/json",...z.headers(t)},body:JSON.stringify(i.profile)}).then(e=>{if(e.status===200)return e.json();throw new Error(`Failed to save profile for ${i.userid}`)}).then(e=>{if(e)return e})}function wo(i,t){return fetch(`/api/profiles/${i.userid}`,{headers:z.headers(t)}).then(e=>{if(e.status===200)return e.json()}).then(e=>{if(e)return console.log("Profile:",e),e})}function $o(){return fetch("/study-spots",{method:"GET",headers:{"Content-Type":"application/json"}}).then(i=>{if(i.status===200)return i.json();throw void 0}).then(i=>{if(i){const{data:t}=i;return t}})}function xo(i){return fetch(`/study-spots/${i.spotid}`,{method:"GET"}).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("Study Spot:",t),t})}function _o(i,t){return fetch("/study-spots",{method:"POST",headers:{"Content-Type":"application/json",...z.headers(t)},body:JSON.stringify(i.spot)}).then(e=>{if(e.status===201)return e.json();throw new Error("Failed to add study spot")}).then(e=>{if(e)return e})}function So(i,t){return fetch(`/study-spots/${i.spotid}`,{method:"PUT",headers:{"Content-Type":"application/json",...z.headers(t)},body:JSON.stringify({ratings:i.ratings,reviewsCount:i.reviewsCount})}).then(e=>{if(e.status===200)return e.json();throw new Error(`Failed to update study spot ${i.spotid}`)}).then(e=>{if(e)return e})}function ko(i){return fetch(`/reviews/spot/${i}`,{method:"GET",headers:{"Content-Type":"application/json"}}).then(t=>{if(t.status===200)return t.json();if(t.status===404)return console.log(`No reviews found for study spot ${i}`),[];throw new Error(`Failed to fetch reviews for study spot ${i}. Status: ${t.status}`)}).then(t=>t||[]).catch(t=>{throw console.error(t.message),t})}function Ao(i,t){return fetch("/reviews",{method:"POST",headers:{"Content-Type":"application/json",...z.headers(t)},body:JSON.stringify(i.review)}).then(e=>{if(e.status===201)return e.json();throw new Error("Failed to add review")}).then(e=>{if(e)return e})}function Eo(i){return fetch(`/reviews/${i}`,{method:"DELETE",headers:{"Content-Type":"application/json"}}).then(t=>{if(t.status!==204)if(t.status===404)console.log(`Review ${i} not found`);else throw new Error(`Failed to delete review ${i}`)})}function Ro(i,t){return fetch(`/reviews/${i._id}`,{method:"PUT",headers:{"Content-Type":"application/json",...z.headers(t)},body:JSON.stringify(i)}).then(e=>{if(e.status===200)return e.json();throw new Error(`Failed to update review ${i._id}`)}).then(e=>{if(e)return e})}function Po(i){return fetch(`/reviews/${i.reviewId}`,{method:"GET"}).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("Review Found:",t),t})}function Oo(i){return fetch(`/reviews/user/${i}`,{method:"GET",headers:{"Content-Type":"application/json"}}).then(t=>{if(t.status===200)return t.json();throw new Error(`Failed to fetch reviews for user ${i}`)}).then(t=>t||[])}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Co={attribute:!0,type:String,converter:Xt,reflect:!1,hasChanged:Ke},To=(i=Co,t,e)=>{const{kind:s,metadata:r}=e;let o=globalThis.litPropertyMetadata.get(r);if(o===void 0&&globalThis.litPropertyMetadata.set(r,o=new Map),o.set(e.name,i),s==="accessor"){const{name:a}=e;return{set(n){const l=t.get.call(this);t.set.call(this,n),this.requestUpdate(a,l,i)},init(n){return n!==void 0&&this.P(a,void 0,i),n}}}if(s==="setter"){const{name:a}=e;return function(n){const l=this[a];t.call(this,n),this.requestUpdate(a,l,i)}}throw Error("Unsupported decorator location: "+s)};function y(i){return(t,e)=>typeof e=="object"?To(i,t,e):((s,r,o)=>{const a=r.hasOwnProperty(o);return r.constructor.createProperty(o,a?{...s,wrapped:!0}:s),a?Object.getOwnPropertyDescriptor(r,o):void 0})(i,t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function w(i){return y({...i,state:!0,attribute:!1})}var Uo=Object.defineProperty,Io=Object.getOwnPropertyDescriptor,Lo=(i,t,e,s)=>{for(var r=s>1?void 0:s?Io(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&Uo(t,e,r),r};const Xe=class Xe extends R{constructor(){super(...arguments),this.iconSrc="/icons/menu.svg",this._onClickAway=t=>{this.contains(t.target)||(this.removeAttribute("open"),window.removeEventListener("click",this._onClickAway))}}render(){return d`
      <slot name="actuator">
  ...
  `;let bt=Xe;Lo([y({type:String})],bt.prototype,"iconSrc",2);customElements.define("drop-down",bt);const E=x`
  * {
    margin: 0;
...
`,jo=localStorage.getItem("dark-mode")==="true";function Mo(){document.body.classList.add("dark-mode"),localStorage.setItem("dark-mode","true")}function zo(){document.body.classList.remove("dark-mode"),localStorage.setItem("dark-mode","false")}function As(i){i?Mo():zo()}As(jo);document.body.addEventListener("dark-mode",()=>{const i=localStorage.getItem("dark-mode")==="true";As(!i)});var Do=Object.defineProperty,No=Object.getOwnPropertyDescriptor,Es=(i,t,e,s)=>{for(var r=s>1?void 0:s?No(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&Do(t,e,r),r};const ie=class ie extends R{constructor(){super(...arguments),this.username="anonymous",this.isDarkMode=localStorage.getItem("dark-mode")==="true",this._authObserver=new T(this,"slostudyspots:auth")}connectedCallback(){super.connectedCallback(),this._authObserver.observe(({user:t})=>{t?this.username=t.username:this.username="anonymous"})}toggleDarkMode(){this.isDarkMode=!this.isDarkMode,localStorage.setItem("dark-mode",this.isDarkMode.toString()),document.body.classList.toggle("dark-mode",this.isDarkMode)}render(){return d`
      <header class="navbar">
  ...
  `];let Lt=ie;Es([w()],Lt.prototype,"username",2);Es([w()],Lt.prototype,"isDarkMode",2);function Fo(i){Ne.relay(i,"auth:message",["auth/signout"])}var qo=Object.defineProperty,Ho=Object.getOwnPropertyDescriptor,it=(i,t,e,s)=>{for(var r=s>1?void 0:s?Ho(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&qo(t,e,r),r};const Rs=x`
  slot[name="avatar"] {
    display: block;
    grid-row: 1 / span 2;
    width: 120px;
...
`,Le="/icons/avatar.svg",Ve=class Ve extends R{render(){return d`
  ...
  `}};Ve.styles=[E,Rs,x`
    ...
    `];let X=ae;it([y({type:Boolean,reflect:!0})],X.prototype,"edit",2);it([y({attribute:"user-id",reflect:!0})],X.prototype,"userid",2);it([w()],X.prototype,"profile",1);it([w()],X.prototype,"newAvatar",2);var Bo=Object.defineProperty,Qo=Object.getOwnPropertyDescriptor,Wo=(i,t,e,s)=>{for(var r=s>1?void 0:s?Qo(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&Bo(t,e,r),r};U({"restful-form":Zr.FormElement});const tr=class tr extends R{constructor(){super(...arguments),this.message=""}render(){return d`
      <restful-form
        new
  ...
  `;let ee=tr;Wo([y()],ee.prototype,"message",2);U({"mu-auth":z.Provider,"login-form":ee});const er=class er extends R{render(){return d`
    ...
    `];let je=er;U({"restful-form":Zr.FormElement});class Go extends R{render(){return d`
...
`;var Jo=Object.defineProperty,Yo=Object.getOwnPropertyDescriptor,Ps=(i,t,e,s)=>{for(var r=s>1?void 0:s?Yo(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&Jo(t,e,r),r};const sr=class sr extends R{constructor(){super(...arguments),this.open=!1,this.sort=!1}openPopup(){this.open=!0}closePopup(t){t.target.classList.contains("popup-overlay")&&(this.open=!1)}triggerSort(t){this.dispatchEvent(new CustomEvent("sort-requested",{detail:{sortType:t}})),this.open=!1}render(){return d`
  ...
  `];let Mt=sr;Ps([y({type:Boolean})],Mt.prototype,"open",2);Ps([w()],Mt.prototype,"sort",2);var Ko=Object.defineProperty,Zo=Object.getOwnPropertyDescriptor,ge=(i,t,e,s)=>{for(var r=s>1?void 0:s?Zo(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&Ko(t,e,r),r};const ne=class ne extends j{constructor(){super("slostudyspots:model"),this.isPopupOpen=!1,this.filterTerm="",this.filteredStudySpots=[],this.updateFilteredStudySpots()}get studySpotIndex(){return this.model.studySpotIndex||[]}connectedCallback(){super.connectedCallback(),this.dispatchMessage(["study-spot/index"])}togglePopup(){this.isPopupOpen=!this.isPopupOpen}updateFilteredStudySpots(){this.filteredStudySpots=this.studySpotIndex.filter(t=>t.name.toLowerCase().includes(this.filterTerm.toLowerCase()))}handleSortRequested(t){t.detail.sortType==="alphabetically"&&(this.studySpotIndex.sort((s,r)=>s.name.localeCompare(r.name)),this.filteredStudySpots=this.studySpotIndex.filter(s=>s.name.toLowerCase().includes(this.filterTerm.toLowerCase()))),this.isPopupOpen=!1}updateFilterTerm(t){const e=t.target;this.filterTerm=e.value,this.updateFilteredStudySpots()}renderStars(t){const e=Math.floor(t),s=t%1>=.5?1:0,r=5-e-s,o=[];for(let a=0;a<e;a++)o.push(d`<span class="star full"></span>`);s&&o.push(d`<span class="star half"></span>`);for(let a=0;a<r;a++)o.push(d`<span class="star empty"></span>`);return d`${o}`}render(){const t=s=>{const{name:r,ratings:o,reviewsCount:a}=s,{_id:n}=s,l=s.photos&&s.photos.length>0?s.photos[0].url:"/icons/default-spot.png",g=o.overall.toFixed(1);return d`
    ...
    `];let tt=ir;fe([y({attribute:"spot-id",reflect:!0})],tt.prototype,"spotid",2);fe([w()],tt.prototype,"studySpot",1);fe([w()],tt.prototype,"reviews",1);fe([w()],tt.prototype,"loading",2);var ta=Object.defineProperty,ea=Object.getOwnPropertyDescriptor,qt=(i,t,e,s)=>{for(var r=s>1?void 0:s?ea(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&ta(t,e,r),r};const le=class le extends j{constructor(){super("slostudyspots:model"),this.loading=!0,this.reviewsFetched=!1,this._authObserver=new T(this,"slostudyspots:auth")}get reviews(){return this.model.reviews||[]}get profile(){return this.model.profile}get studySpots(){return this.model.studySpotIndex||[]}get studySpotMap(){const t=new Map;return this.studySpots.forEach(e=>t.set(e._id,e)),t}fetchStudySpots(){this.dispatchMessage(["study-spot/index"])}connectedCallback(){super.connectedCallback(),this._authObserver.observe(({user:t})=>{if(t&&!this.reviewsFetched){console.log("Authenticated user:",t.username),this.loading=!0,this.dispatchMessage(["profile/select",{userid:t.username}]);const e=this.model.profile;e&&e._id?(console.log("Profile fetched with _id:",e._id),this.dispatchMessage(["review/list-by-user",{userId:e._id}]),this.fetchStudySpots(),this.reviewsFetched=!0):console.warn("Profile _id is not set. Review list message not dispatched."),setTimeout(()=>this.loading=!1,100)}})}formatDate(t){return new Date(t).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}renderStars(t){const e=Math.floor(t),s=t%1>=.5?1:0,r=5-e-s,o=[];for(let a=0;a<e;a++)o.push(d`<span class="star full"></span>`);s&&o.push(d`<span class="star half"></span>`);for(let a=0;a<r;a++)o.push(d`<span class="star empty"></span>`);return d`${o}`}renderSubratings(t){return d`
    ...
    `];let H=le;qt([w()],H.prototype,"reviews",1);qt([w()],H.prototype,"profile",1);qt([w()],H.prototype,"studySpots",1);qt([w()],H.prototype,"studySpotMap",1);qt([w()],H.prototype,"loading",2);var ra=Object.defineProperty,sa=Object.getOwnPropertyDescriptor,ot=(i,t,e,s)=>{for(var r=s>1?void 0:s?sa(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&ra(t,e,r),r};const or=class or extends j{constructor(){super("slostudyspots:model"),this.name="",this.address="",this.locationType="",this.customLocationType="",this.tags="",this.link="",this.createdBy="",this._authObserver=new T(this,"slostudyspots:auth")}connectedCallback(){super.connectedCallback(),this._authObserver.observe(({user:t})=>{t&&(this.createdBy=t.username)})}render(){return d`
    <main>
    ...
    `];let L=or;ot([y({type:String})],L.prototype,"name",2);ot([y({type:String})],L.prototype,"address",2);ot([y({type:String})],L.prototype,"locationType",2);ot([y({type:String})],L.prototype,"customLocationType",2);ot([y({type:String})],L.prototype,"tags",2);ot([y({type:String})],L.prototype,"link",2);ot([y({type:String})],L.prototype,"createdBy",2);var ia=Object.defineProperty,oa=Object.getOwnPropertyDescriptor,aa=(i,t,e,s)=>{for(var r=s>1?void 0:s?oa(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&ia(t,e,r),r};const ar=class ar extends j{get sortedStudySpots(){return[...this.model.studySpotIndex||[]].sort((t,e)=>{const s=e.ratings.overall-t.ratings.overall;return s!==0?s:e.reviewsCount-t.reviewsCount})}constructor(){super("slostudyspots:model")}connectedCallback(){super.connectedCallback(),this.dispatchMessage(["study-spot/index"])}renderStars(t){const e=Math.floor(t),s=t%1>=.5?1:0,r=5-e-s,o=[];for(let a=0;a<e;a++)o.push(d`<span class="star full"></span>`);s&&o.push(d`<span class="star half"></span>`);for(let a=0;a<r;a++)o.push(d`<span class="star empty"></span>`);return d`${o}`}render(){const t=e=>{const{name:s,ratings:r,reviewsCount:o}=e,{_id:a}=e;return d`
      <a href="study-spot/${a}">
        <li class="ranking">
          <div class="content">
            <h3>${s}</h3>
    ...
    `];let re=ar;aa([w()],re.prototype,"sortedStudySpots",1);var na=Object.defineProperty,la=Object.getOwnPropertyDescriptor,I=(i,t,e,s)=>{for(var r=s>1?void 0:s?la(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&na(t,e,r),r};const nr=class nr extends j{constructor(){super("slostudyspots:model"),this.quietnessRating=0,this.wifiQualityRating=0,this.crowdednessRating=0,this.powerOutletRating=0,this.amenitiesRating=0,this.comment="",this.bestTimeToGo="",this.overallRating=0,this.spotid="",this._authObserver=new T(this,"slostudyspots:auth")}get profile(){return this.model.profile}get studySpot(){return this.model.studySpot}attributeChangedCallback(t,e,s){super.attributeChangedCallback(t,e,s),t==="spot-id"&&e!==s&&s&&(console.log("Study spot being reviewed:",s),this.dispatchMessage(["study-spot/select",{spotid:s}]))}connectedCallback(){super.connectedCallback(),this._authObserver.observe(({user:t})=>{t&&(this.profile||this.dispatchMessage(["profile/select",{userid:t.username}]))})}calculateOverallRating(){return(this.quietnessRating+this.wifiQualityRating+this.crowdednessRating+this.powerOutletRating+this.amenitiesRating)/5}render(){var t;return console.log("My Profile:",this.profile),console.log("Study Spot:",this.studySpot),d`
      <main>
    ...
    `];let wt=ce;Ze([y({attribute:"review-id",reflect:!0})],wt.prototype,"reviewId",2);Ze([w()],wt.prototype,"review",1);Ze([w()],wt.prototype,"studySpot",1);var ga=Object.defineProperty,fa=Object.getOwnPropertyDescriptor,me=(i,t,e,s)=>{for(var r=s>1?void 0:s?fa(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&ga(t,e,r),r};const cr=class cr extends R{constructor(){super(...arguments),this.url="",this.uploadedBy="",this.uploadDate="",this.open=!1}_close(){this.open=!1;const t=new CustomEvent("close-popup",{detail:{closed:!0}});this.dispatchEvent(t)}_handleOverlayClick(t){t.target.classList.contains("overlay")&&this._close()}render(){return console.log("Rendering ImageViewer with URL:",this.url),d`
  ...
  `;let et=cr;me([y({type:String})],et.prototype,"url",2);me([y({type:String})],et.prototype,"uploadedBy",2);me([y({type:String})],et.prototype,"uploadDate",2);me([y({type:Boolean,reflect:!0})],et.prototype,"open",2);var ma=Object.defineProperty,va=Object.getOwnPropertyDescriptor,ve=(i,t,e,s)=>{for(var r=s>1?void 0:s?va(t,e):t,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(t,e,r):a(r))||r);return s&&r&&ma(t,e,r),r};const de=class de extends j{constructor(){super("slostudyspots:model"),this.spotid="",this.selectedPhoto=null,this.selectedFile=null,this.username="anonymous",this._authObserver=new T(this,"slostudyspots:auth")}get studySpot(){return this.model.studySpot}connectedCallback(){super.connectedCallback(),this._authObserver.observe(({user:t})=>{t?this.username=t.username:this.username="anonymous"})}attributeChangedCallback(t,e,s){super.attributeChangedCallback(t,e,s),t==="spot-id"&&e!==s&&s&&(console.log("Study Spot Page:",s),this.dispatchMessage(["study-spot/select",{spotid:s}]))}_viewImage(t){console.log("Photo clicked:",t),this.selectedPhoto=t}_closeViewer(){this.selectedPhoto=null}goBack(){window.history.back()}render(){var e,s,r;const{photos:t}=this.studySpot||{};return console.log("PHOTOS",t),console.log("USERNAME",this.username),d`
      <main>
    ...
    `];let rt=de;ve([y({attribute:"spot-id",reflect:!0})],rt.prototype,"spotid",2);ve([w()],rt.prototype,"studySpot",1);ve([y({type:Object})],rt.prototype,"selectedPhoto",2);ve([w()],rt.prototype,"username",2);const ya=[{auth:"protected",path:"/app/profile/:id/edit",view:i=>d`
    ...
    `},{path:"/app/login",view:()=>d` <login-view></login-view> `},{path:"/app/register",view:()=>d` <register-view></register-view> `},{path:"/app",view:()=>d`
      <home-view></home-view>
    `},{path:"/",redirect:"/app"}];U({"mu-auth":z.Provider,"mu-history":st.Provider,"mu-store":class extends ti.Provider{constructor(){super(yo,vo,"slostudyspots:auth")}},"mu-switch":class extends Bi.Element{constructor(){super(ya,"slostudyspots:history","slostudyspots:auth")}updated(t){super.updated(t),window.scrollTo(0,0)}},"nav-header":Lt,"profile-view":X,"login-view":je,"register-view":Me,"home-view":V,"study-spot-view":tt,"add-spot-view":L,"rankings-view":re,"add-review-view":O,"user-review-view":H,"account-view":se,"update-review-view":wt,"gallery-view":rt});
